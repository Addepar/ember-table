...
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  ...
  data.buffer.push("<div class=\"antiscroll-wrap\">\n  <div class=\"ember-table-table-scrollable-wrapper antiscroll-inner\">\n    ");
...
Ember.Table.BodyTableContainer = Ember.Table.TableContainer.extend(Ember.MouseWheelHandlerMixin, Ember.ScrollHandlerMixin, {
  ...
  classNames: ['ember-table-table-container', 'ember-table-body-container', 'antiscroll-inner'],
  ...
  onScroll: function(event) {
    ...
    if ($.browser.mozilla) {
      if (parseInt($.browser.version) >= 13) {
        oldPosition = this.get('scrollTop');
        newPosition = event.target.scrollTop;
        if (newPosition > oldPosition) {
          event.target.scrollTop += this.get('firefoxScrollDistance');
