...
Ember.Table.TableController = Ember.Controller.extend({
  ...
  _bodyHeight: Ember.computed(function() {
    ...
    return bodyHeight;
  }).property('_tablesContainerHeight', '_hasHorizontalScrollbar', 'headerHeight', 'footerHeight', 'hasHeader', 'hasFooter', '_scrollbarSize'),
...
Ember.Table.HeaderCell = Ember.View.extend(Ember.StyleBindingsMixin, {
  ...
  height: Ember.computed(function() {
    ...
    return this.get('controller.headerHeight');
    return 30;
