/*! For license information please see chunk.997.035d0e96ded0375d5562.js.LICENSE.txt */
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&R(e,t)}function R(e,t){return R=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(e,t){return e.__proto__=t,e},R(e,t)}function S(e,t,r){O(e,t),t.set(e,r)}function _(e,t){O(e,t),t.add(e)}function O(e,t){if(t.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")}function M(e,t){return e.get(P(e,t))}function I(e,t,r){return e.set(P(e,t),r),r}function P(e,t,r){if("function"==typeof e?e===t:e.has(t))return arguments.length<3?t:r
...
t.exports=ke()()?Object.assign:Re()})),_e=le((function(e,t){"use strict"
var r=he(),n={function:!0,object:!0}
t.exports=function(e){return r(e)&&n[o(e)]||!1}})),Oe=le((function(e,t){"use strict"
var r=Se(),n=_e(),a=he(),o=Error.captureStackTrace
...
var r=Pe(),n=ze(),a=Se(),o=me(),i=He(),u=t.exports=function(e,t){var n,u,s,l,c
...
var r=Nt()
t.exports=function(e){try{return e&&r(e.toString)?e.toString():String(e)}catch(e){return"<Non-coercible to string value>"}}})),St=le((function(e,t){"use strict"
var r=Rt(),n=/[\n\r\u2028\u2029]/g
t.exports=function(e){var t=r(e)
return t.length>100&&(t=t.slice(0,99)+"…"),t.replace(n,(function(e){return JSON.stringify(e).slice(1,-1)}))}})),_t=le((function(e,t){function r(e){return!!e&&("object"===o(e)||"function"==typeof e)&&"function"==typeof e.then}t.exports=r,t.exports.default=r})),Ot=le((function(){"use strict"
var e=Ct(),t=kt(),r=Bt(),n=St(),a=_t(),o=xt(),i=Object.create,u=t("then","then:finally","done","done:finally")
...
var e=lt(),t=xe(),r=xt(),n=_t(),a=Pt(),o=Ae(),i=Function.prototype,u=Math.max,s=Math.min,l=Object.create
...
function B(t,r,n){r.constructor===t.constructor&&n===E&&r.constructor.resolve===C?function(e,t){t._state===N?_(e,t._result):t._state===T?O(e,t._result):M(t,void 0,(function(t){return R(e,t)}),(function(t){return O(e,t)}))}(t,r):void 0===n?_(t,r):e(n)?function(e,t,r){l((function(e){var n=!1,a=function(r,a){try{r.call(a,(function(r){n||(n=!0,t!==r?R(e,r):_(e,r))}),(function(t){n||(n=!0,O(e,t))}))}catch(e){return e}}(r,t,e._label)
!n&&a&&(n=!0,O(e,a))}),e)}(t,r,n):_(t,r)}function R(e,t){if(e===t)O(e,new TypeError("You cannot resolve a promise with itself"))
else if(a=o(n=t),null===n||"object"!==a&&"function"!==a)_(e,t)
else{var r=void 0
try{r=t.then}catch(t){return void O(e,t)}B(e,t,r)}var n,a}function S(e){e._onerror&&e._onerror(e._result),I(e)}function _(e,t){e._state===k&&(e._result=t,e._state=N,0!==e._subscribers.length&&l(I,e))}function O(e,t){e._state===k&&(e._state=T,e._result=t,l(S,e))}function M(e,t,r,n){var a=e._subscribers,o=a.length
...
r._state!==k||(o&&s?R(r,i):!1===s?O(r,u):t===N?_(r,i):t===T&&O(r,i))}var j=0
...
n._state===k&&(this._remaining--,e===T?O(n,r):this._result[t]=r),0===this._remaining&&_(n,this._result)},e.prototype._willSettleAt=function(e,t){var r=this
...
return m}function S(e,t,r){var n,a,o,i,u,s,l,d,p=[]
for(n=e.length;n;n-=1)for(o=e[n-1],a=8;a;a-=1)p.push(o%2?1:0),o>>=1
return p.reverse(),i=p.join(""),u=(1<<t-1)-1,s=parseInt(i.substring(0,1),2)?-1:1,l=parseInt(i.substring(1,1+t),2),d=parseInt(i.substring(1+t),2),l===(1<<t)-1?0===d?s*(1/0):NaN:l>0?s*c(2,l-u)*(1+d/c(2,r)):0!==d?s*c(2,-(u-1))*(d/c(2,r)):s<0?-0:0}function _(e){return S(e,11,52)}function O(e){return R(e,11,52)}function M(e){return S(e,8,23)}function I(e){return R(e,8,23)}f=Object.defineProperty&&function(){try{return Object.defineProperty({},"x",{}),!0}catch(e){return!1}}()?Object.defineProperty:function(e,t,r){if(!e===Object(e))throw new TypeError("Object.defineProperty called on non-object")
...
var i=a(1,v,b),u=a(1,y,F),s=a(1,w,F),l=a(2,E,C),c=a(2,x,A),d=a(4,k,N),h=a(4,T,B),D=a(4,I,M),g=a(8,O,_)
...
t.exports=Object.hasOwn||function(e,t){return a(n(e),t)}})),Sr=le((function(e,t){"use strict"
var r=er(),n=0,a=Math.random(),o=r(1..toString)
t.exports=function(e){return"Symbol("+(void 0===e?"":e)+")_"+o(++n+a,36)}})),_r=le((function(e,t){"use strict"
var r=Kt(),n=Tr(),a=Rr(),o=Sr(),i=br(),u=yr(),s=r.Symbol,l=n("wks"),c=u?s.for||s:s&&s.withoutSetter||o
t.exports=function(e){return a(l,e)||(l[e]=i&&a(s,e)?s[e]:c("Symbol."+e)),l[e]}})),Or=le((function(e,t){"use strict"
var r=ir(),n=fr(),a=Fr(),o=Cr(),i=xr(),u=_r(),s=TypeError,l=u("toPrimitive")
...
var r={}
r[_r()("toStringTag")]="z",t.exports="[object z]"===String(r)})),Dn=le((function(e,t){"use strict"
var r=mn(),n=ar(),a=tr(),o=_r()("toStringTag"),i=Object,u="Arguments"===a(function(){return arguments}())
...
var r,n,a,o=Xt(),i=ar(),u=fr(),s=Cn(),l=Zr(),c=xn(),d=_r(),p=Ar(),f=d("iterator"),h=!1;[].keys&&("next"in(a=[].keys())?(n=l(l(a)))!==Object.prototype&&(r=n):h=!0),!u(r)||o((function(){var e={}
...
var r=mn(),n=Ur().f,a=Hr(),o=Rr(),i=kn(),u=_r()("toStringTag")
...
var r=er(),n=Er()
t.exports=function(e,t,a){try{return r(n(Object.getOwnPropertyDescriptor(e,t)[a]))}catch(e){}}})),Sn=le((function(e,t){"use strict"
var r=ar(),n=String,a=TypeError
t.exports=function(e){if("object"==o(e)||r(e))return e
throw new a("Can't set "+n(e)+" as a prototype")}})),_n=le((function(e,t){"use strict"
var r=Rn(),n=Vr(),a=Sn()
...
var r=$r(),n=ir(),a=Ar(),o=Fn(),i=ar(),u=Bn(),s=Zr(),l=_n(),c=Nn(),d=Hr(),p=xn(),f=_r(),h=Tn(),m=An(),D=o.PROPER,g=o.CONFIGURABLE,v=m.IteratorPrototype,b=m.BUGGY_SAFARI_ITERATORS,y=f("iterator"),F="keys",w="values",E="entries",C=function(){return this}
t.exports=function(e,t,o,f,m,x,A){u(o,t,f)
var k,N,T,B=function(e){if(e===m&&M)return M
if(!b&&e&&e in _)return _[e]
switch(e){case F:case w:case E:return function(){return new o(this,e)}}return function(){return new o(this)}},R=t+" Iterator",S=!1,_=e.prototype,O=_[y]||_["@@iterator"]||m&&_[m],M=!b&&O||B(m),I="Array"===t&&_.entries||O
if(I&&(k=s(I.call(new e)))!==Object.prototype&&k.next&&(a||s(k)===v||(l?l(k,v):i(k[y])||p(k,y,C)),c(k,R,!0,!0),a&&(h[R]=C)),D&&m===w&&O&&O.name!==w&&(!a&&g?d(_,"name",w):(S=!0,M=function(){return n(O,this)})),m)if(N={values:B(w),keys:x?M:B(F),entries:B(E)},A)for(T in N)(b||S||!(T in _))&&p(_,T,N[T])
else r({target:t,proto:!0,forced:b||S},N)
return a&&!A||_[y]===M||p(_,y,M,{name:m}),h[t]=M,N}})),Mn=le((function(e,t){"use strict"
...
var r=_r(),n=Tn(),a=r("iterator"),o=Array.prototype
...
var r=Dn(),n=Cr(),a=cr(),o=Tn(),i=_r()("iterator")
...
ce(na,{DqElement:function(){return to},aggregate:function(){return aa},aggregateChecks:function(){return ca},aggregateNodeResults:function(){return pa},aggregateResult:function(){return ha},areStylesSet:function(){return ma},assert:function(){return Da},checkHelper:function(){return ro},clone:function(){return no},closest:function(){return yo},collectResultsFromFrames:function(){return mi},contains:function(){return Di},convertSelector:function(){return go},cssParser:function(){return io},deepMerge:function(){return gi},escapeSelector:function(){return va},extendMetaData:function(){return vi},filterHtmlAttrs:function(){return dm},finalizeRuleResult:function(){return da},findBy:function(){return pi},getAllChecks:function(){return di},getAncestry:function(){return Ga},getBaseLang:function(){return Xf},getCheckMessage:function(){return ih},getCheckOption:function(){return uh},getEnvironmentData:function(){return sh},getFlattenedTree:function(){return Yf},getFrameContexts:function(){return yh},getFriendlyUriEnd:function(){return wa},getNodeAttributes:function(){return Ea},getNodeFromTree:function(){return Za},getPreloadConfig:function(){return om},getRootNode:function(){return wi},getRule:function(){return Fh},getScroll:function(){return Eh},getScrollState:function(){return xh},getSelector:function(){return Ua},getSelectorData:function(){return Pa},getShadowSelector:function(){return Na},getStandards:function(){return Ah},getStyleSheetFactory:function(){return Nh},getXpath:function(){return Ya},injectStyle:function(){return Th},isArrayLike:function(){return Bh},isContextObject:function(){return _h},isContextProp:function(){return Oh},isContextSpec:function(){return Sh},isHidden:function(){return Ph},isHtmlElement:function(){return jh},isLabelledFramesSelector:function(){return Mh},isLabelledShadowDomSelector:function(){return Ih},isNodeInContext:function(){return qh},isShadowRoot:function(){return yi},isValidLang:function(){return Em},isXHTML:function(){return ka},matchAncestry:function(){return zh},matches:function(){return uo},matchesExpression:function(){return bo},matchesSelector:function(){return Ca},memoize:function(){return Aa},mergeResults:function(){return hi},nodeLookup:function(){return Uh},nodeSerializer:function(){return ci},nodeSorter:function(){return Vh},objectHasOwn:function(){return Rh},parseCrossOriginStylesheet:function(){return Gh},parseSameOriginStylesheet:function(){return Hh},parseStylesheet:function(){return $h},performanceTimer:function(){return Wh},pollyfillElementsFromPoint:function(){return Yh},preload:function(){return nm},preloadCssom:function(){return Zh},preloadMedia:function(){return rm},processMessage:function(){return oh},publishMetaData:function(){return im},querySelectorAll:function(){return sm},querySelectorAllFilter:function(){return Xh},queue:function(){return xo},respondable:function(){return ni},ruleShouldRun:function(){return cm},select:function(){return fm},sendCommandToFrame:function(){return oi},setScrollState:function(){return mm},shadowSelect:function(){return Dm},shadowSelectAll:function(){return vm},shouldPreload:function(){return am},toArray:function(){return ga},tokenList:function(){return zf},uniqueArray:function(){return Qh},uuid:function(){return zo},validInputTypes:function(){return ym},validLangs:function(){return wm}})
...
function _a(e){return e.replace(Ra,"\\$1").replace(Sa,"\\a ")}function Oa(e,t){var r,n=t.name
if(-1!==n.indexOf("href")||-1!==n.indexOf("src")){var a=wa(e.getAttribute(n))
r=a?va(t.name)+'$="'+_a(a)+'"':va(t.name)+'="'+_a(e.getAttribute(n))+'"'}else r=va(n)+'="'+_a(t.value)+'"'
...
return No}}for(var To="function"==typeof r.Buffer?r.Buffer:Array,Bo=[],Ro={},So=0;So<256;So++)Bo[So]=(So+256).toString(16).substr(1),Ro[Bo[So]]=So
function _o(e,t){var r=t||0,n=Bo
...
return t||_o(a)}function Lo(e,t,r){var n=t&&r||0
...
return t||_o(a)}(Eo=Lo).v1=qo,Eo.v4=Lo,Eo.parse=function(e,t,r){var n=t&&r||0,a=0
for(t=t||[],e.toLowerCase().replace(/[0-9a-f]{2}/g,(function(e){a<16&&(t[n+a++]=Ro[e])}));a<16;)t[n+a++]=0
return t},Eo.unparse=_o,Eo.BufferClass=To,i._uuid=qo()
...
ce(Fi,{createGrid:function(){return yu},findElmsInContext:function(){return Ci},findNearbyElms:function(){return Tu},findUp:function(){return Ai},findUpVirtual:function(){return xi},focusDisabled:function(){return Iu},getComposedParent:function(){return Wi},getElementByReference:function(){return Lu},getElementCoordinates:function(){return Qi},getElementStack:function(){return $u},getModalDialog:function(){return Ru},getOverflowHiddenAncestors:function(){return Ti},getRootNode:function(){return Ei},getScrollOffset:function(){return Yi},getTabbableElements:function(){return Gu},getTargetRects:function(){return Ku},getTargetSize:function(){return Xu},getTextElementStack:function(){return Ml},getViewportSize:function(){return Ki},getVisibleChildTextRects:function(){return _l},hasContent:function(){return zl},hasContentVirtual:function(){return Ll},hasLangText:function(){return Vl},idrefs:function(){return Ju},insertedIntoFocusOrder:function(){return Ul},isCurrentPageLink:function(){return qu},isFocusable:function(){return Yu},isHTML5:function(){return Wl},isHiddenForEveryone:function(){return Hi},isHiddenWithCSS:function(){return Gl},isInTabOrder:function(){return Qu},isInTextBlock:function(){return Zl},isInert:function(){return Su},isModalOpen:function(){return Jl},isMultiline:function(){return ec},isNativelyFocusable:function(){return Wu},isNode:function(){return tc},isOffscreen:function(){return Xi},isOpaque:function(){return wf},isSkipLink:function(){return Ef},isVisible:function(){return kf},isVisibleOnScreen:function(){return Ji},isVisibleToScreenReaders:function(){return Qs},isVisualContent:function(){return Pl},reduceToElementsBelowFloating:function(){return Nf},shadowElementsFromPoint:function(){return Sf},urlPropsFromAttribute:function(){return If},visuallyContains:function(){return Tf},visuallyOverlaps:function(){return Pf},visuallySort:function(){return zu}})
...
var o=sm(i._tree,'img[usemap="#'.concat(va(n),'"]'))
return!o||!o.length||o.some((function(e){return!t(e)}))}function Vi(e){var t
return"details"===(null===(t=e.parent)||void 0===t?void 0:t.props.nodeName)&&("summary"!==e.props.nodeName||e.parent.children.find((function(e){return"summary"===e.props.nodeName}))!==e)&&!e.parent.hasAttr("open")}var Ui=[_i,Oi,Mi,Vi]
function Hi(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=t.skipAncestors,n=t.isAncestor,a=void 0!==n&&n
return e=Uh(e).vNode,r?$i(e,a):Gi(e,a)}var $i=Aa((function(e,t){return!(!Si(e)&&(!e.actualNode||!Ui.some((function(r){return r(e,{isAncestor:t})}))&&e.actualNode.isConnected))})),Gi=Aa((function(e,t){return!!$i(e,t)||!!e.parent&&Gi(e.parent,!0)})),Wi=function e(t){if(t.assignedSlot)return e(t.assignedSlot)
...
function Su(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=t.skipAncestors,n=t.isAncestor
return r?_u(e,n):Ou(e,n)}var _u=Aa((function(e,t){if(e.hasAttr("inert"))return!0
if(!t&&e.actualNode){var r=Ru()
if(r&&!Di(r,e))return!0}return!1})),Ou=Aa((function(e,t){return!!_u(e,t)||!!e.parent&&Ou(e.parent,!0)})),Mu=["button","command","fieldset","keygen","optgroup","option","select","textarea","input"],Iu=function(e){var t,r=Uh(e).vNode
if(t=r.props.nodeName,Mu.includes(t)&&r.hasAttr("disabled")||Su(r))return!0
...
return r?Hu(r,t.boundingClientRect):[]},Gu=function(e){return sm(e,"*").filter((function(e){var t=e.isFocusable,r=e.actualNode.getAttribute("tabindex")
return(r=r&&!isNaN(parseInt(r,10))?parseInt(r):null)?t&&r>=0:t}))},Wu=function(e){var t=Uh(e).vNode
if(!t||Iu(t))return!1
...
return!(!r||isNaN(parseInt(r,10)))}function Qu(e){var t=Uh(e).vNode
return 1===t.props.nodeType&&!(parseInt(t.attr("tabindex",10))<=-1)&&Yu(t)}var Ku=Aa((function(e){var t=e.boundingClientRect,r=Tu(e).filter((function(t){return du(e,t)&&"none"!==t.getComputedStylePropertyValue("pointer-events")&&!function(e,t){return Di(e,t)&&!Qu(t)}(e,t)}))
...
function ks(e,t){return!!t(e)}var Ns=function(e,t){return Es(cs(e),t)},Ts=function(e,t){return Es(js(e),t)},Bs=function(e,t){return e=Uh(e).vNode,Es(e.props.nodeName,t)},Rs=function(e,t){return e=Uh(e).vNode,xs((function(t){return e.props[t]}),t)},Ss=function(e,t){return Es(Us(e),t)},_s={hasAccessibleName:Cs,attributes:As,condition:ks,explicitRole:Ns,implicitRole:Ts,nodeName:Bs,properties:Rs,semanticRole:Ss},Os=function e(t,r){return t=Uh(t).vNode,Array.isArray(r)?r.some((function(r){return e(t,r)})):"string"==typeof r?uo(t,r):Object.keys(r).every((function(e){if(!_s[e])throw new Error('Unknown matcher type "'.concat(e,'"'))
var n=_s[e],a=r[e]
return n(t,a)}))},Ms=function(e,t){return Os(e,t)}
Ms.hasAccessibleName=Cs,Ms.attributes=As,Ms.condition=ks,Ms.explicitRole=Ns,Ms.fromDefinition=Os,Ms.fromFunction=xs,Ms.fromPrimative=Es,Ms.implicitRole=Ts,Ms.nodeName=Bs,Ms.properties=Rs,Ms.semanticRole=Ss
...
if(!el(t))return""
var r=sm(t,"option"),n=r.filter((function(e){return e.props.selected}))
...
var n=va(e.attr("id"))
if(r=(t=Ei(e.actualNode).querySelector('label[for="'+n+'"]'))&&Nl(t,!0))return r}return(r=(t=yo(e,"label"))&&Xs(t,!0))||null},Bl=function(e){return e=Za(e),Tl(e)},Rl=[{matches:[{nodeName:"textarea"},{nodeName:"input",properties:{type:["text","password","search","tel","email","url"]}}],namingMethods:"labelText"},{matches:{nodeName:"input",properties:{type:["button","submit","reset"]}},namingMethods:["valueText","titleText","buttonDefaultText"]},{matches:{nodeName:"input",properties:{type:"image"}},namingMethods:["altText","valueText","labelText","titleText","buttonDefaultText"]},{matches:"button",namingMethods:"subtreeText"},{matches:"fieldset",namingMethods:"fieldsetLegendText"},{matches:"OUTPUT",namingMethods:"subtreeText"},{matches:[{nodeName:"select"},{nodeName:"input",properties:{type:/^(?!text|password|search|tel|email|url|button|submit|reset)/}}],namingMethods:"labelText"},{matches:"summary",namingMethods:"subtreeText"},{matches:"figure",namingMethods:["figureText","titleText"]},{matches:"img",namingMethods:"altText"},{matches:"table",namingMethods:["tableCaptionText","tableSummaryText"]},{matches:["hr","br"],namingMethods:["titleText","singleSpace"]}],Sl=function e(t){var r=Ji(t),n=[]
return t.children.forEach((function(t){3===t.actualNode.nodeType?r&&n.push(t):n=n.concat(e(t))})),n},_l=Aa((function(e){var t=Za(e),r=t.boundingClientRect,n=[],o=Ti(t)
...
var t=Za(e)._grid
return t?_l(e).map((function(e){return Hu(t,e)})):[]},Il=["checkbox","img","meter","progressbar","scrollbar","radio","slider","spinbutton","textbox"],Pl=function(e){var t=Uh(e).vNode,r=i.commons.aria.getExplicitRole(t)
...
function Vl(e){return!(void 0!==e.children&&!ql(e))||(1===e.props.nodeType&&Pl(e)?!!i.commons.text.accessibleTextVirtual(e):e.children.some((function(e){return!e.attr("lang")&&Vl(e)&&!Hi(e)})))}var Ul=function(e){return parseInt(e.getAttribute("tabindex"),10)>-1&&Yu(e)&&!Wu(e)}
...
if(Xh(i._tree[0],"dialog, [role=dialog], [aria-modal=true]",Ji).length)return Xa.set("isModalOpen",!0),!0
...
throw new TypeError("Only Bradford CAT with white points D50 and D65 supported for now.")}var Sc=(e=new WeakSet,t=new WeakMap,W((function r(n){var a,o,i,u,s,l,c
$(this,r),_(this,e),S(this,t,void 0),this.id=n.id,this.name=n.name,this.base=n.base?Sc.get(n.base):null,this.aliases=n.aliases,this.base&&(this.fromBase=n.fromBase,this.toBase=n.toBase)
...
return!1}},{key:"getFormat",value:function(t){return"object"===o(t)?t=P(e,this,_c).call(this,t):(r="default"===t?Object.values(this.formats)[0]:this.formats[t])?r=P(e,this,_c).call(this,r):null
var r}},{key:"to",value:function(e,r){if(1===arguments.length){var n=[e.space,e.coords]
e=n[0],r=n[1]}if(this===(e=Sc.get(e)))return r
...
e=r[0],t=r[1]}return(e=Sc.get(e)).to(this,t)}},{key:"toString",value:function(){return"".concat(this.name," (").concat(this.id,")")}},{key:"getMinCoords",value:function(){var e=[]
for(var t in this.coords){var r,n=this.coords[t],a=n.range||n.refRange
e.push(null!==(r=null==a?void 0:a.min)&&void 0!==r?r:0)}return e}}],[{key:"all",get:function(){return q(new Set(Object.values(Sc.registry)))}},{key:"register",value:function(e,t){if(1===arguments.length&&(e=(t=arguments[0]).id),t=this.get(t),this.registry[e]&&this.registry[e]!==t)throw new Error("Duplicate color space registration: '".concat(e,"'"))
if(this.registry[e]=t,1===arguments.length&&t.aliases){var r,n=Q(t.aliases)
try{for(n.s();!(r=n.n()).done;){var a=r.value
this.register(a,t)}}catch(e){n.e(e)}finally{n.f()}}return t}},{key:"get",value:function(e){if(!e||e instanceof Sc)return e
if("string"===gc(e)){var t=Sc.registry[e.toLowerCase()]
...
if(n.length)return Sc.get.apply(Sc,n)
...
if((r=Sc.get(r))||(r=t),!r)throw new TypeError("Cannot resolve coordinate reference ".concat(e,": No color space specified and relative references are not allowed here"))
if("number"===(a=gc(n))||"string"===a&&n>=0){var u=Object.entries(r.coords)[n]
if(u)return z({space:r,id:u[0],index:n},u[1])}r=Sc.get(r)
...
var N,T=m-c,B=x-C,R=(k*=ed)-(A*=ed),S=A+k,_=Math.abs(R)
...
return t*Math.pow(r,2.4)}var Rd=216/24389,Sd=24/116,_d=24389/27,Od=Tc.D65,Md=new Mc({id:"lab-d65",name:"Lab D65",coords:{l:{refRange:[0,100],name:"L"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:Od,base:Ic,fromBase:function(e){var t=e.map((function(e,t){return e/Od[t]})).map((function(e){return e>Rd?Math.cbrt(e):(_d*e+16)/116}))
return[116*t[1]-16,500*(t[0]-t[1]),200*(t[1]-t[2])]},toBase:function(e){var t=[]
return t[1]=(e[0]+16)/116,t[0]=e[1]/500+t[1],t[2]=t[1]-e[2]/200,[t[0]>Sd?Math.pow(t[0],3):(116*t[0]-16)/_d,e[0]>8?Math.pow((e[0]+16)/116,3):e[0]/_d,t[2]>Sd?Math.pow(t[2],3):(116*t[2]-16)/_d].map((function(e,t){return e*Od[t]}))},formats:{"lab-d65":{coords:["<number> | <percentage>","<number>","<number>"]}}}),Id=.5*Math.pow(5,.5)+.5,Pd=Object.freeze({__proto__:null,contrastWCAG21:function(e,t){e=qc(e),t=qc(t)
...
if($(this,e),_(this,re),S(this,G,void 0),S(this,X,void 0),S(this,Z,void 0),S(this,J,void 0),S(this,ee,void 0),S(this,te,void 0),t instanceof gf){var o=t.r,i=t.g,u=t.b
...
return!t||e.compareDocumentPosition(t.actualNode)===e.DOCUMENT_POSITION_FOLLOWING}function Cf(){return(r.location.origin?sm(i._tree,'a[href]:not([href^="javascript:"])').find((function(e){return!qu(e.actualNode)})):sm(i._tree,'a:not([href^="#"]):not([href^="/#"]):not([href^="javascript:"])')[0])||null}var xf=/rect\s*\(([0-9]+)px,?\s*([0-9]+)px,?\s*([0-9]+)px,?\s*([0-9]+)px\s*\)/,Af=/(\w+)\((\d+)/,kf=function e(t,n,a){var o
...
return(["scroll","auto"].includes(a)||t instanceof r.HTMLHtmlElement)&&(u.width=t.scrollWidth,u.height=t.scrollHeight),1===o.length&&"hidden"===a&&"nowrap"===n.getPropertyValue("white-space")&&(o[0]=u),o.some((function(e){return!(Math.ceil(e.left)<Math.floor(u.left)||Math.ceil(e.top)<Math.floor(u.top)||Math.floor(e.left+e.width)>Math.ceil(u.left+u.width)||Math.floor(e.top+e.height)>Math.ceil(u.top+u.height))}))}var Sf=function e(t,r){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:a,o=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0
...
o=a._isXHTML?o:(o||"").toLowerCase(),ym().includes(o)||(o="text"),a._type=o}return Xa.get("nodeMap")&&Xa.get("nodeMap").set(e,a),a}return B(t,e),W(t,[{key:"props",get:function(){if(!this._cache.hasOwnProperty("props")){var e=this.actualNode,t=e.nodeType,r=e.nodeName,n=e.id,a=e.nodeValue
...
return{node:e,include:[],exclude:[],initiator:!1,focusable:r&&dh(e),size:ph(e),page:n}}function dh(e){var t=e.getAttribute("tabindex")
if(!t)return!0
var r=parseInt(t,10)
return isNaN(r)||r>=0}function ph(e){var t=parseInt(e.getAttribute("width"),10),r=parseInt(e.getAttribute("height"),10)
...
n.push.apply(n,q(u.map((function(e){return Za(e)}))))}}return n.filter((function(e){return e}))}function vh(e,t,r){e.frames=e.frames||[],vm(r.shift()).forEach((function(n){var a=e.frames.find((function(e){return e.node===n}))
...
if(u instanceof r.Document)return u.documentElement}return a.documentElement}(e)),this.exclude=e.exclude,this.include=e.include,this.include=gh(this,"include"),this.exclude=gh(this,"exclude"),fm("frame, iframe",this).forEach((function(e){qh(e,c)&&function(e,t){Qs(t)&&!pi(e.frames,"node",t)&&e.frames.push(ch(t,e))}(c,e.actualNode)})),void 0===this.page&&(this.page=1===(l=this.include).length&&l[0].actualNode===a.documentElement,this.frames.forEach((function(e){e.page=c.page}))),function(e){if(0===e.include.length&&0===e.frames.length){var t=ni.isInFrame()?"frame":"page"
...
return $h(r.sheet,t,n,a,r.isCrossOrigin)}))},Wh=function(){function e(){if(r.performance&&r.performance)return r.performance.now()}var t=null,n=e()
...
return a.head.removeChild(o),l}}"function"==typeof r.addEventListener&&(a.elementsFromPoint=Yh())
var Qh=function(e,t){return e.concat(t).filter((function(e,t,r){return r.indexOf(e)===t}))}
function Kh(e,t,r,n,a){var o=a||{}
return o.vNodes=e,o.vNodesIndex=0,o.anyLevel=t,o.thisLevel=r,o.parentShadowId=n,o}var Xh=function(e,t,r){e=Array.isArray(e)?e:[e]
var n=go(t)
return Uf(e,n,r)||function(e,t,r){for(var n=Xa.get("qsa.recycledLocalVariables",(function(){return[]})),a=[],o=Kh(Array.isArray(e)?e:[e],t,null,e[0].shadowId,n.pop()),i=[];o.vNodesIndex<o.vNodes.length;){for(var u,s,l=o.vNodes[o.vNodesIndex++],c=null,d=null,p=((null===(u=o.anyLevel)||void 0===u?void 0:u.length)||0)+((null===(s=o.thisLevel)||void 0===s?void 0:s.length)||0),f=!1,h=0;h<p;h++){var m,D,g,v=h<((null===(m=o.anyLevel)||void 0===m?void 0:m.length)||0)?o.anyLevel[h]:o.thisLevel[h-((null===(D=o.anyLevel)||void 0===D?void 0:D.length)||0)]
...
">"===b[0].combinator?(c=c||[]).push(b):(d=d||[]).push(b)}v[0].id&&l.shadowId!==o.parentShadowId||null===(g=o.anyLevel)||void 0===g||!g.includes(v)||(d=d||[]).push(v)}for(l.children&&l.children.length&&(a.push(o),o=Kh(l.children,d,c,l.shadowId,n.pop()));o.vNodesIndex===o.vNodes.length&&a.length;)n.push(o),o=a.pop()}return i}(e,n,r)},Zh=function(e){var t=e.treeRoot,r=function(e){var t=[],r=Xh(e,"*",(function(e){return!t.includes(e.shadowId)&&(t.push(e.shadowId),!0)})).map((function(e){return{shadowId:e.shadowId,rootNode:wi(e.actualNode)}}))
return Qh(r,[])}(void 0===t?i._tree[0]:t)
...
return n=11===e.nodeType&&t?function(e,t){return Array.from(e.children).filter(em).reduce((function(r,n){var a=n.nodeName.toUpperCase(),o="STYLE"===a?n.textContent:n,i=t({data:o,isLink:"LINK"===a,root:e})
return i.sheet&&r.push(i.sheet),r}),[])}(e,r):function(e){return Array.from(e.styleSheets).filter((function(e){return!!e.media&&tm(e.media.mediaText)}))}(e),function(e){var t=[]
...
r.push(c)})),Promise.all(r)}(r,Nh(n)).then((function(e){return Jh(e)}))}
function Jh(e){return e.reduce((function(e,t){return Array.isArray(t)?e.concat(Jh(t)):e.concat(t)}),[])}function em(e){var t=e.nodeName.toUpperCase(),r=e.getAttribute("href"),n=e.getAttribute("rel"),a="LINK"===t&&r&&n&&e.rel.toUpperCase().includes("STYLESHEET")
return"STYLE"===t||a&&tm(e.media)}function tm(e){return!e||!e.toUpperCase().includes("PRINT")}var rm=function(e){var t=e.treeRoot,r=void 0===t?i._tree[0]:t,n=Xh(r,"video, audio",(function(e){var t=e.actualNode
...
function nm(e){var t={cssom:Zh,media:rm}
return am(e)?new Promise((function(r,n){var a=om(e),o=a.assets,i=a.timeout,u=setTimeout((function(){return n(new Error("Preload assets timed out."))}),i)
...
clearTimeout(u),r(t)})).catch((function(e){clearTimeout(u),n(e)}))})):Promise.resolve()}function am(e){return!e||void 0===e.preload||null===e.preload||("boolean"==typeof e.preload?e.preload:(t=e.preload,"object"===o(t)&&Array.isArray(t.assets)))
var t}function om(e){var t=Jn.preload,r=t.assets,n=t.timeout,a={assets:r,timeout:n}
...
return a.assets=Qh(e.preload.assets.map((function(e){return e.toLowerCase()})),[]),e.preload.timeout&&"number"==typeof e.preload.timeout&&!isNaN(e.preload.timeout)&&(a.timeout=e.preload.timeout),a}function im(e){var t=i._audit.data.checks||{},r=i._audit.data.rules||{},n=pi(i._audit.rules,"id",e.id)||{}
e.tags=no(n.tags||[])
var a=um(t,!0,n),o=um(t,!1,n)
e.nodes.forEach((function(e){e.any.forEach(a),e.all.forEach(a),e.none.forEach(o)})),vi(e,no(r[e.id]||{}))}function um(e,t,r){return function(n){var a=e[n.id]||{},i=a.messages||{},u=Object.assign({},a)
...
return null!==(t=this._attrs[e])&&void 0!==t?t:null}},{key:"hasAttr",value:function(e){return void 0!==this._attrs[e]}},{key:"attrNames",get:function(){return Object.keys(this._attrs)}}])}(ra),xm={"#cdata-section":2,"#text":3,"#comment":8,"#document":9,"#document-fragment":11},Am={}
Object.keys(xm).forEach((function(e){Am[xm[e]]=e}))
var km,Nm=Cm,Tm=function(e,t){if(e=e||function(){},t=t||i.log,!i._audit)throw new Error("No audit configured")
...
i.utils.querySelectorAll(o,"iframe, frame").forEach((function(e){r.defer((function(t,r){return i.utils.sendCommandToFrame(e.actualNode,{command:"cleanup-plugin"},t,r)}))})),r.then((function(r){0===n.length?e(r):t(n)})).catch(t)},Bm={}
function Rm(e){return Bm.hasOwnProperty(e)}function Sm(e){return"string"==typeof e&&Bm[e]?Bm[e]:"function"==typeof e?e:km}var _m={}
ce(_m,{getAllCells:function(){return Om},getCellPosition:function(){return hs},getHeaders:function(){return Im},getScope:function(){return ms},isColumnHeader:function(){return Ds},isDataCell:function(){return Pm},isDataTable:function(){return jm},isHeader:function(){return qm},isRowHeader:function(){return gs},toArray:function(){return fs},toGrid:function(){return fs},traverse:function(){return zm}})
var Om=function(e){var t,r,n,a,o=[]
for(t=0,n=e.rows.length;t<n;t++)for(r=0,a=e.rows[t].cells.length;r<a;r++)o.push(e.rows[t].cells[r])
return o}
function Mm(e,t,r){for(var n,a="row"===e?"_rowHeaders":"_colHeaders",o="row"===e?gs:Ds,u=r[t.y][t.x],s=u.colSpan-1,l=u.getAttribute("rowspan"),c=(0===parseInt(l)||0===u.rowspan?r.length:u.rowSpan)-1,d=t.y+c,p=t.x+s,f="row"===e?t.y:0,h="row"===e?0:t.x,m=[],D=d;D>=f&&!n;D--)for(var g=p;g>=h;g--){var v=r[D]?r[D][g]:void 0
if(v){var b=i.utils.getNodeFromTree(v)
if(b[a]){n=b[a]
break}m.push(v)}}return n=(n||[]).concat(m.filter(o)),m.forEach((function(e){i.utils.getNodeFromTree(e)[a]=n})),n}var Im=function(e,t){if(e.getAttribute("headers")){var r=Ju(e,"headers")
if(r.filter((function(e){return e})).length)return r}t||(t=fs(Ai(e,"table")))
var n=hs(e,t),a=Mm("row",n,t),o=Mm("col",n,t)
return[].concat(a,o).reverse()},Pm=function(e){if(!e.children.length&&!e.textContent.trim())return!1
var t=e.getAttribute("role")
return ls(t)?["cell","gridcell"].includes(t):"TD"===e.nodeName.toUpperCase()},jm=function(e){var t=(e.getAttribute("role")||"").toLowerCase()
...
h=r.getComputedStyle(o).getPropertyValue("background-image")}return s>=20||!(Qi(e).width>.95*Ki(r).width)&&!(u<10)&&!e.querySelector("object, embed, iframe, applet")},qm=function(e){if(Ds(e)||gs(e))return!0
if(e.getAttribute("id")){var t=va(e.getAttribute("id"))
return!!a.querySelector('[headers~="'.concat(t,'"]'))}return!1}
function Lm(e,t,r,n){var a,o=r[t.y]?r[t.y][t.x]:void 0
return o?"function"==typeof n&&!0===(a=n(o,t,r))?[o]:((a=Lm(e,{x:t.x+e.x,y:t.y+e.y},r,n)).unshift(o),a):[]}var zm=function(e,t,r,n){if(Array.isArray(t)&&(n=r,r=t,t={x:0,y:0}),"string"==typeof e)switch(e){case"left":e={x:-1,y:0}
break
case"up":e={x:0,y:-1}
break
case"right":e={x:1,y:0}
break
case"down":e={x:0,y:1}}return Lm(e,{x:t.x+e.x,y:t.y+e.y},r,n)},Vm={}
ce(Vm,{allowedAttr:function(){return Um},arialabelText:function(){return rs},arialabelledbyText:function(){return ts},getAccessibleRefs:function(){return Gm},getElementUnallowedRoles:function(){return Km},getExplicitRole:function(){return cs},getImplicitRole:function(){return js},getOwnedVirtual:function(){return Ws},getRole:function(){return Us},getRoleType:function(){return Yl},getRolesByType:function(){return Zm},getRolesWithNameFromContents:function(){return eD},implicitNodes:function(){return oD},implicitRole:function(){return js},isAccessibleRef:function(){return iD},isAriaRoleAllowedOnElement:function(){return Wm},isComboboxPopup:function(){return uD},isUnsupportedRole:function(){return ss},isValidRole:function(){return ls},label:function(){return lD},labelVirtual:function(){return kl},lookupTable:function(){return aD},namedFromContents:function(){return Gs},requiredAttr:function(){return cD},requiredContext:function(){return dD},requiredOwned:function(){return pD},validateAttr:function(){return hD},validateAttrValue:function(){return fD}})
var Um=function(e){var t=us.ariaRoles[e],r=q(ps())
return t?(t.allowedAttrs&&r.push.apply(r,q(t.allowedAttrs)),t.requiredAttrs&&r.push.apply(r,q(t.requiredAttrs)),r):r},Hm=/^idrefs?$/
function $m(e,t,r){if(e.hasAttribute){if("LABEL"===e.nodeName.toUpperCase()&&e.hasAttribute("for")){var n=e.getAttribute("for")
...
return!(!t.parentNode||"http://www.w3.org/2000/svg"!==t.parentNode.namespaceURI)||r}},nD.rolesOfType={widget:["button","checkbox","dialog","gridcell","link","log","marquee","menuitem","menuitemcheckbox","menuitemradio","option","progressbar","radio","scrollbar","searchbox","slider","spinbutton","status","switch","tab","tabpanel","textbox","timer","tooltip","tree","treeitem"]}
var aD=nD,oD=function(e){var t=null,r=aD.role[e]
return r&&r.implicit&&(t=no(r.implicit)),t},iD=function(e){return!!Gm(e).length}
function uD(e){var t,r=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).popupRoles,n=Us(e)
...
return Array.from(i).some(sD)}var sD=function(e){return e&&"combobox"===Us(e)},lD=function(e){return e=Za(e),kl(e)},cD=function(e){var t=us.ariaRoles[e]
return t&&Array.isArray(t.requiredAttrs)?q(t.requiredAttrs):[]},dD=function(e){var t=us.ariaRoles[e]
return t&&Array.isArray(t.requiredContext)?q(t.requiredContext):null},pD=function(e){var t=us.ariaRoles[e]
return t&&Array.isArray(t.requiredOwned)?q(t.requiredOwned):null},fD=function(e,t){var r,n,a=(e=e instanceof ra?e:Za(e)).attr(t),o=us.ariaAttrs[t]
if(!o)return!0
...
return/^[-+]?[0-9]+$/.test(a)&&parseInt(a)>=u}},hD=function(e){return!!us.ariaAttrs[e]}
function mD(e){return"caption"===e.props.nodeName}var DD={}
ce(DD,{getAriaRolesByType:function(){return Xm},getAriaRolesSupportingNameFromContent:function(){return Jm},getElementSpec:function(){return Ps},getElementsByContentType:function(){return ds},getGlobalAriaAttrs:function(){return ps},implicitHtmlRoles:function(){return ws}})
var gD=["alert","log","status"]
function vD(e,t){var r=e.actualNode
if("button"===Us(e)||function(e,t){var r=e.actualNode,n=Us(e),a=(r.getAttribute("aria-live")||"").toLowerCase().trim(),o=Xm("landmark")
return!!(["assertive","polite"].includes(a)||gD.includes(n)||o.includes(n)||t.regionMatcher&&Is(e,t.regionMatcher))}(e,t)||["iframe","frame"].includes(e.props.nodeName)||Ef(e.actualNode)&&Lu(e.actualNode,"href")||!Qs(r)){for(var n=e;n;)n._hasRegionDescendant=!0,n=n.parent
return["iframe","frame"].includes(e.props.nodeName)?[e]:[]}return r!==a.body&&zl(r,!0)&&!function(e){return["none","presentation"].includes(Us(e))&&!ql(e)}(e)?[e]:e.children.filter((function(e){return 1===e.actualNode.nodeType})).map((function(e){return vD(e,t)})).reduce((function(e,t){return e.concat(t)}),[])}function bD(e){switch(e){case"lighter":return 100
case"normal":return 400
case"bold":return 700
case"bolder":return 900}return e=parseInt(e),isNaN(e)?400:e}function yD(e){var t=r.getComputedStyle(function(e){for(var t=e,r=e.textContent.trim(),n=r;n===r&&void 0!==t;){var a=-1
...
return{fontWeight:bD(t.getPropertyValue("font-weight")),fontSize:parseInt(t.getPropertyValue("font-size")),isItalic:"italic"===t.getPropertyValue("font-style")}}function FD(e,t,r){return r.reduce((function(r,n){return r||(!n.size||e.fontSize/n.size>t.fontSize)&&(!n.weight||e.fontWeight-n.weight>t.fontWeight)&&(!n.italic||e.isItalic&&!t.isItalic)}),!1)}var wD=/[;,\s]/,ED=/^[0-9.]+$/,CD={}
ce(CD,{aria:function(){return Vm},color:function(){return xD},dom:function(){return Fi},forms:function(){return og},matches:function(){return Is},math:function(){return nu},standards:function(){return DD},table:function(){return _m},text:function(){return Zu},utils:function(){return na}})
var xD={}
ce(xD,{Color:function(){return bf},centerPointOfRect:function(){return AD},elementHasImage:function(){return oc},elementIsDistinct:function(){return ND},filteredRectStack:function(){return BD},flattenColors:function(){return _D},flattenShadowColors:function(){return MD},getBackgroundColor:function(){return ZD},getBackgroundStack:function(){return ID},getContrast:function(){return tg},getForegroundColor:function(){return rg},getOwnBackgroundColor:function(){return Ff},getRectStack:function(){return TD},getStackingContext:function(){return WD},getStrokeColorsFromShadows:function(){return VD},getTextShadowColors:function(){return $D},hasValidContrastRatio:function(){return ag},incompleteData:function(){return ac},parseTextShadows:function(){return HD},stackingContextToColor:function(){return YD}})
var AD=function(e){if(!(e.left>r.innerWidth||e.top>r.innerHeight))return{x:Math.min(Math.ceil(e.left+e.width/2),r.innerWidth-1),y:Math.min(Math.ceil(e.top+e.height/2),r.innerHeight-1)}}
function kD(e){return e.getPropertyValue("font-family").split(/[,;]/g).map((function(e){return e.trim().toLowerCase()}))}var ND=function(e,t){var n=r.getComputedStyle(e)
...
return i.split(" ").length<3&&(o=o||i!==a.getPropertyValue("text-decoration")),o},TD=function(e){var t=$u(e),r=Ml(e)
return!r||r.length<=1?[t]:r.some((function(e){return void 0===e}))?null:(r.splice(0,0,t),r)},BD=function(e){var t=TD(e)
if(t&&1===t.length)return t[0]
if(t&&t.length>1){var r,n=t.shift()
return t.forEach((function(a,o){if(0!==o){var i=t[o-1],u=t[o]
r=i.every((function(e,t){return e===u[t]}))||n.includes(e)}})),r?t[0]:(ac.set("bgColor","elmPartiallyObscuring"),null)}return ac.set("bgColor","outsideViewport"),null},RD=["hue","saturation","color","luminosity"],SD={normal:function(e,t){return t},multiply:function(e,t){return t*e},screen:function(e,t){return e+t-e*t},overlay:function(e,t){return this["hard-light"](t,e)},darken:function(e,t){return Math.min(e,t)},lighten:function(e,t){return Math.max(e,t)},"color-dodge":function(e,t){return 0===e?0:1===t?1:Math.min(1,e/(1-t))},"color-burn":function(e,t){return 1===e?1:0===t?0:1-Math.min(1,(1-e)/t)},"hard-light":function(e,t){return t<=.5?this.multiply(e,2*t):this.screen(e,2*t-1)},"soft-light":function(e,t){return t<=.5?e-(1-2*t)*e*(1-e):e+(2*t-1)*((e<=.25?((16*e-12)*e+4)*e:Math.sqrt(e))-e)},difference:function(e,t){return Math.abs(e-t)},exclusion:function(e,t){return e+t-2*e*t},hue:function(e,t){return t.setSaturation(e.getSaturation()).setLuminosity(e.getLuminosity())},saturation:function(e,t){return e.setSaturation(t.getSaturation()).setLuminosity(e.getLuminosity())},color:function(e,t){return t.setLuminosity(e.getLuminosity())},luminosity:function(e,t){return e.setLuminosity(t.getLuminosity())}}
function _D(e,t){var r,n=function(e,t,r){if(RD.includes(r))return SD[r](e,t)
var n=new bf
return["r","g","b"].forEach((function(a){n[a]=SD[r](e[a],t[a])})),n}(t,e,arguments.length>2&&void 0!==arguments[2]?arguments[2]:"normal"),a=OD(e.red,e.alpha,t.red,t.alpha,255*n.r),o=OD(e.green,e.alpha,t.green,t.alpha,255*n.g),i=OD(e.blue,e.alpha,t.blue,t.alpha,255*n.b),u=(r=e.alpha+t.alpha*(1-e.alpha),Math.min(Math.max(0,r),1))
if(0===u)return new bf(a,o,i,u)
var s=Math.round(a/u),l=Math.round(o/u),c=Math.round(i/u)
return new bf(s,l,c,u)}function OD(e,t,r,n,a){return t*(1-n)*e+t*n*a+(1-t)*n*r}function MD(e,t){var r=e.alpha,n=(1-r)*t.red+r*e.red,a=(1-r)*t.green+r*e.green,o=(1-r)*t.blue+r*e.blue,i=e.alpha+t.alpha*(1-e.alpha)
return new bf(n,a,o,i)}function ID(e){for(var t=Ml(e).map((function(t){return function(e){var t=e.indexOf(a.body),n=e,o=Ff(r.getComputedStyle(a.documentElement))
...
if(0!==n&&!PD(o,t[0]))return ac.set("bgColor","elmPartiallyObscuring"),null}return t[0]||null}function PD(e,t){if(e===t)return!0
if(null===e||null===t)return!1
if(e.length!==t.length)return!1
for(var r=0;r<e.length;++r)if(e[r]!==t[r])return!1
return!0}var jD=.54,qD=.5,LD=1.5,zD=["top","right","bottom","left"]
function VD(e){var t=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).ignoreEdgeCount,r=void 0!==t&&t,n=function(e){var t,r={},n=Q(e)
...
c>qD?s.right.push(c):-c>qD&&s.left.push(-c),d>qD?s.bottom.push(d):-d>qD&&s.top.push(-d)}}catch(e){n.e(e)}finally{n.f()}return r}(e),a=Object.entries(n).map((function(e){var t=V(e,2),r=t[0],n=t[1],a=zD.filter((function(e){return 0!==n[e].length})).length
return{colorStr:r,sides:n,edgeCount:a}}))
return!r&&a.some((function(e){var t=e.edgeCount
return t>1&&t<4}))?null:a.map(UD).filter((function(e){return null!==e}))}function UD(e){var t=e.colorStr,r=e.sides
if(4!==e.edgeCount)return null
var n=new bf
n.parseString(t)
var a=0,o=!0
return zD.forEach((function(e){a+=r[e].length/4,o&&(o=r[e].every((function(e){return e>LD})))})),o||(n.alpha=1-Math.pow(jD,a)),n}function HD(e){var t={pixels:[]},r=e.trim(),n=[t]
if(!r)return[]
...
2===t.length&&t.push(0)})),n}function $D(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.minRatio,a=t.maxRatio,o=t.ignoreEdgeCount,i=[],u=r.getComputedStyle(e),s=u.getPropertyValue("text-shadow")
if("none"===s)return i
...
i.push.apply(i,q(F)),p.splice(0,p.length)}var w=GD({colorStr:m,offsetX:g,offsetY:v,blurRadius:y,fontSize:c})
i.push(w)}}}catch(e){f.e(e)}finally{f.f()}if(p.length>0){var E=VD(p,{ignoreEdgeCount:o})
if(null===E)return null
i.push.apply(i,q(E))}return i}function GD(e){var t=e.colorStr,r=e.offsetX,n=e.offsetY,a=e.blurRadius,o=e.fontSize
if(r>a||n>a)return new bf(0,0,0,0)
var i=new bf
return i.parseString(t),i.alpha*=function(e,t){return 0===e?1:.185/(e/t+.4)}(a,o),i}function WD(e,t){var r,n=Za(e)
if(n._stackingContext)return n._stackingContext
var a=[],o=new Map
return(t=null!==(r=t)&&void 0!==r?r:ID(e)).forEach((function(e){var t,r=Za(e),n=function(e){var t=new bf
...
i.forEach((function(e,t){var r,n=e.vNode,u=null===(r=i[t-1])||void 0===r?void 0:r.vNode,s=XD(o,n,u)
0!==t||o.get(n)||a.unshift(s),o.set(n,s)}))
var u=null===(t=i[i.length-1])||void 0===t?void 0:t.vNode,s=XD(o,r,u)
i.length||a.unshift(s),s.bgColor=n})),n._stackingContext=a,a}function YD(e){var t
if(null===(t=e.descendants)||void 0===t||!t.length){var r=e.bgColor
return r.alpha*=e.opacity,{color:r,blendMode:e.blendMode}}var n=_D(e.descendants.reduce(QD,KD()),e.bgColor,e.descendants[0].blendMode)
return n.alpha*=e.opacity,{color:n,blendMode:e.blendMode}}function QD(e,t){var r
return r=e instanceof bf?e:YD(e).color,_D(YD(t).color,r,t.blendMode)}function KD(e,t){var r,n
return{vNode:e,ancestor:t,opacity:parseFloat(null!==(r=null==e?void 0:e.getComputedStylePropertyValue("opacity"))&&void 0!==r?r:1),bgColor:new bf(0,0,0,0),blendMode:(n=null==e?void 0:e.getComputedStylePropertyValue("mix-blend-mode"),n||void 0),descendants:[]}}function XD(e,t,r){var n,a=e.get(r),o=null!==(n=e.get(t))&&void 0!==n?n:KD(t,a)
return a&&r!==t&&!a.descendants.includes(o)&&a.descendants.unshift(o),o}function ZD(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:.1,o=Za(e),i=o._cache.getBackgroundColor
if(i)return t.push.apply(t,q(i.bgElms)),ac.set("bgColor",i.incompleteData),i.bgColor
var u=function(e,t,n){var o,i,u=ID(e)
if(!u)return null
var s=_l(e),l=null!==(o=$D(e,{minRatio:n,ignoreEdgeCount:!0}))&&void 0!==o?o:[]
l.length&&(l=[{color:l.reduce(MD)}])
for(var c=0;c<u.length;c++){var d=u[c],p=r.getComputedStyle(d)
if(oc(d,p))return t.push(d),null
var f=Ff(p)
if(0!==f.alpha){if("inline"!==p.getPropertyValue("display")&&!JD(d,s))return t.push(d),ac.set("bgColor","elmPartiallyObscured"),null
if(t.push(d),1===f.alpha)break}}l=WD(e,u).map(YD).concat(l)
var h=function(e,t){var n=[]
if(!t){var o=a.documentElement,i=a.body,u=r.getComputedStyle(o),s=r.getComputedStyle(i),l=Ff(u),c=Ff(s),d=0!==c.alpha&&JD(i,e.getBoundingClientRect());(0!==c.alpha&&0===l.alpha||d&&1!==c.alpha)&&n.unshift({color:c,blendMode:eg(s.getPropertyValue("mix-blend-mode"))}),0!==l.alpha&&(!d||d&&1!==c.alpha)&&n.unshift({color:l,blendMode:eg(u.getPropertyValue("mix-blend-mode"))})}return n}(e,u.includes(a.body))
if((i=l).unshift.apply(i,q(h)),0===l.length)return new bf(255,255,255,1)
var m=l.reduce((function(e,t){return _D(t.color,e.color instanceof bf?e.color:e,t.blendMode)}))
return _D(m.color instanceof bf?m.color:m,new bf(255,255,255,1))}(e,t,n)
return o._cache.getBackgroundColor={bgColor:u,bgElms:t,incompleteData:ac.get("bgColor")},u}function JD(e,t){t=Array.isArray(t)?t:[t]
var n=e.getBoundingClientRect(),a=n.right,o=n.bottom,i=r.getComputedStyle(e).getPropertyValue("overflow")
return(["scroll","auto"].includes(i)||e instanceof r.HTMLHtmlElement)&&(a=n.left+e.scrollWidth,o=n.top+e.scrollHeight),t.every((function(e){return e.top>=n.top&&e.bottom<=o&&e.left>=n.left&&e.right<=a}))}function eg(e){return e||void 0}var tg=function(e,t){if(!t||!e)return null
t.alpha<1&&(t=_D(t,e))
var r=e.getRelativeLuminance(),n=t.getRelativeLuminance()
return(Math.max(n,r)+.05)/(Math.min(n,r)+.05)}
function rg(e,t,n){for(var a,o=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{},i=r.getComputedStyle(e),u=[function(){return function(e,t){var r=t.textStrokeEmMin,n=void 0===r?0:r,a=parseFloat(e.getPropertyValue("-webkit-text-stroke-width"))
if(0===a)return null
...
return(new bf).parseString(u)}(i,o)},function(){return function(e){return(new bf).parseString(e.getPropertyValue("-webkit-text-fill-color")||e.getPropertyValue("color"))}(i)},function(){return $D(e,{minRatio:0})}],s=[],l=0,c=u;l<c.length;l++){var d=(0,c[l])()
if(d&&(s=s.concat(d),1===d.alpha))break}var p=s.reduce((function(e,t){return _D(e,t)}))
if(null!==(a=n)&&void 0!==a||(n=ZD(e,[])),null===n){var f=ac.get("bgColor")
return ac.set("fgColor",f),null}var h=WD(e)
return _D(function(e,t,r){for(;t;){var n
...
var o=a.map(YD)
if(o.length){var i=o.reduce((function(e,t){return _D(t.color,e.color instanceof bf?e.color:e)}),{color:new bf(0,0,0,0),blendMode:"normal"})
e=_D(e,i),t=t.ancestor}else t=t.ancestor}}return e}(p,ng(h,e),h),new bf(255,255,255,1))}function ng(e,t){var r,n=Q(e)
try{for(n.s();!(r=n.n()).done;){var a,o=r.value
if((null===(a=o.vNode)||void 0===a?void 0:a.actualNode)===t)return o
var i=ng(o.descendants,t)
if(i)return i}}catch(e){n.e(e)}finally{n.f()}}var ag=function(e,t,r,n){var a=tg(e,t),o=n&&Math.ceil(72*r)/96<14||!n&&Math.ceil(72*r)/96<18?4.5:3
return{isValid:a>o,contrastRatio:a,expectedContrastRatio:o}},og={}
ce(og,{isAriaCombobox:function(){return nl},isAriaListbox:function(){return rl},isAriaRange:function(){return ol},isAriaTextbox:function(){return tl},isDisabled:function(){return ug},isNativeSelect:function(){return el},isNativeTextbox:function(){return Js}})
var ig=["fieldset","button","select","input","textarea"],ug=function e(t){var r=t._isDisabled
if("boolean"==typeof r)return r
var n=t.props.nodeName,a=t.attr("aria-disabled")
return r=!(!ig.includes(n)||!t.hasAttr("disabled"))||(a?"true"===a.toLowerCase():!!t.parent&&e(t.parent)),t._isDisabled=r,r}
...
return o(n)===o(a)&&("object"===o(n)||"object"===o(a)?sg(n,a):n===a)}))}function lg(e){var t=Us(e),r=t&&t.includes("heading"),n=e.attr("aria-level"),a=parseInt(n,10),o=V(e.props.nodeName.match(/h(\d)/)||[],2)[1]
return r?o&&!n?parseInt(o,10):isNaN(a)||a<1?o?parseInt(o,10):2:a||-1:-1}function cg(e,t){var r,n=null===(r=t.data)||void 0===r?void 0:r.headingOrder,a=pg(t.node.ancestry,1)
if(!n)return e
var o=n.map((function(e){return function(e,t){return z({},e,{ancestry:t.concat(e.ancestry)})}(e,a)})),i=function(e,t){for(;t.length;){var r=dg(e,t)
if(-1!==r)return r
t=pg(t,1)}return-1}(e,a)
return-1===i?e.push.apply(e,q(o)):e.splice.apply(e,[i,0].concat(q(o))),e}function dg(e,t){return e.findIndex((function(e){return zh(e.ancestry,t)}))}function pg(e,t){return e.slice(0,e.length-t)}function fg(e,t){var r=e.boundingClientRect,n=t.boundingClientRect
return r.top>=n.top&&r.left>=n.left&&r.bottom<=n.bottom&&r.right<=n.right}function hg(e){return e.getComputedStylePropertyValue("pointer-events")}function mg(e){return{width:Math.round(10*e.width)/10,height:Math.round(10*e.height)/10}}function Dg(e,t){return Di(e,t)&&!Qu(t)}function gg(e){return e.map((function(e){return e.actualNode}))}function vg(e,t,r){var n=r.validRoles,a=void 0===n?[]:n,o=r.validNodeNames,i=void 0===o?[]:o,u=e.props,s=u.nodeName,l=u.nodeType,c=u.nodeValue,d=t?"div > ":""
...
return e.map((function(e){return{vChild:e,nested:t}}))}function yg(e){return""!==(e||"").trim()}function Fg(e){var t=El(e,{emoji:!0,nonBmp:!0,punctuations:!0})
return vs(t)}function wg(e){if(!e.children){if(1===e.props.nodeType)throw new Error("Cannot determine children")
return[]}var t=[]
return e.children.forEach((function(e){"widget"===Yl(e)&&Yu(e)?t.push(e):t.push.apply(t,q(wg(e)))})),t}function Eg(e){var t=parseInt(e.attr("tabindex"),10)
return!isNaN(t)&&t<0}function Cg(e){if(Qu(e))return!0
...
function Ag(e){var t=r.getComputedStyle(e).getPropertyValue("display")
return-1!==xg.indexOf(t)||"table-"===t.substr(0,6)}function kg(e,t){var r=e.getRelativeLuminance(),n=t.getRelativeLuminance()
return(Math.max(r,n)+.05)/(Math.min(r,n)+.05)}var Ng=["block","list-item","table","flex","grid","inline-block"]
function Tg(e){var t=r.getComputedStyle(e).getPropertyValue("display")
return-1!==Ng.indexOf(t)||"table-"===t.substr(0,6)}var Bg=Aa((function(e,t){var n=r.getComputedStyle(e,t),a=function(e,t){return n.getPropertyValue(e)===t}
...
var o=Rg(n.getPropertyValue("width")),i=Rg(n.getPropertyValue("height"))
return"px"!==o.unit||"px"!==i.unit?0===o.value||0===i.value?0:1/0:o.value*i.value}))
function Rg(e){var t=V(e.match(/^([0-9.]+)([a-z]+)$/i)||[],3),r=t[1],n=void 0===r?"":r,a=t[2],o=void 0===a?"":a
return{value:parseFloat(n),unit:o.toLowerCase()}}var Sg={ARTICLE:!0,ASIDE:!0,NAV:!0,SECTION:!0},_g={alert:!0,alertdialog:!0,application:!0,article:!0,banner:!1,complementary:!0,contentinfo:!0,dialog:!0,form:!0,log:!0,main:!0,navigation:!0,region:!0,search:!1,status:!0}
function Og(e,t,r,n){var a=cs(e)
if(r||(r=dD(a)),!r)return null
for(var o=r.includes("group"),i=n?e:e.parent;i;){var u=Us(i,{noPresentational:!0})
if(u){if("group"!==u||!o)return r.includes(u)?null:r
t.includes(a)&&r.push(a),r=r.filter((function(e){return"group"!==e})),i=i.parent}else i=i.parent}return r}function Mg(e){var t=e.vNode
return 3===t.props.nodeType?t.props.nodeValue.trim().length>0:Ll(t,!1,!0)}var Ig=Aa((function(e){if(e){var t=Us(e,{noPresentational:!0,chromium:!0})
return t?Yl(t):Ig(e.parent)}}))
function Pg(e){var t,r,n=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).invalidTableRowAttrs,a=arguments.length>2?arguments[2]:void 0,o=null!==(t=null==n||null===(r=n.filter)||void 0===r?void 0:r.call(n,(function(e){return a.hasAttr(e)})))&&void 0!==t?t:[]
...
return this.data({messageKey:s,invalidAttrs:o,ownerRole:u}),!1}function jg(e,t,r){var n,a=r.props,o=a.nodeName,i=a.type,u=(n=r.attr("aria-checked"))?(n=n.toLowerCase(),["mixed","true"].includes(n)?n:"false"):""
if("input"!==o||"checkbox"!==i||!u)return!0
var s,l=(s=r).props.indeterminate?"mixed":s.props.checked?"true":"false"
return u===l||(this.data({messageKey:"checkbox",checkState:l}),!1)}var qg={row:Pg,checkbox:jg}
function Lg(e,t,r){return"aria-required"===e&&"false"===t||!("aria-multiline"!==e||"false"!==t||!r.hasAttr("contenteditable"))}var zg=function(e,t){try{return"svg"===t.props.nodeName||!!yo(t,"svg")}catch(e){return!1}},Vg=[function(e,t){return Ug(t)},function(e,t){return function(e){return"area"!==e.props.nodeName}(t)},function(e,t){return!zg(0,t)},function(e,t){return Yu(t)},function(e,t){return Qu(t)||!Hg(t)},function(e){return!Zl(e,{noLengthCompare:!0})}]
function Ug(e){return"widget"===Yl(e)}var Hg=Aa((function e(t){return!(null==t||!t.parent)&&(!(!Ug(t.parent)||!Qu(t.parent))||e(t.parent))})),$g=function(e,t){var r=cs(t)
...
return r.setStart(e,0),r.setEnd(e,e.childNodes.length),0===r.getClientRects().length}var Wg=function(e,t,r){return r.initiator},Yg={emoji:!0,nonBmp:!1,punctuations:!0}
function Qg(e){return!e||"true"!==e.getAttribute("aria-hidden")&&Qg(Wi(e))}var Kg={"abstractrole-evaluate":function(e,t,r){var n=zf(r.attr("role")).filter((function(e){return"abstract"===Yl(e)}))
...
return"string"==typeof n&&/^\s+$/.test(n)},"aria-allowed-attr-evaluate":function(e,t,r){var n=[],a=Us(r),o=Um(a)
Array.isArray(t[a])&&(o=Qh(t[a].concat(o)))
var i,u=Q(r.attrNames)
try{for(u.s();!(i=u.n()).done;){var s=i.value
!hD(s)||o.includes(s)||Lg(s,r.attr(s),r)||n.push(s)}}catch(e){u.e(e)}finally{u.f()}return!n.length||(this.data(n.map((function(e){return e+'="'+r.attr(e)+'"'}))),!(a||jh(r)||Yu(r))&&void 0)},"aria-allowed-attr-matches":function(e,t){var r=/^aria-/,n=t.attrNames
...
return!qg[n]||qg[n].call(this,e,t,r)},"aria-conditional-checkbox-attr-evaluate":jg,"aria-conditional-row-attr-evaluate":Pg,"aria-errormessage-evaluate":function(e,t,r){t=Array.isArray(t)?t:[]
...
return a?a.prohibitedAttrs||[]:t||n.includes(r)||"widget"===Ig(e)?[]:["aria-label","aria-labelledby"]}(r,o,a,n).filter((function(e){return!!r.attrNames.includes(e)&&""!==vs(r.attr(e))}))
if(0===i.length)return!1
...
return""===vs(s)||void 0},"aria-required-attr-evaluate":function(e){var t,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2?arguments[2]:void 0,a=cs(n),o=n.attrNames,i=cD(a)
if(Array.isArray(r[a])&&(i=Qh(r[a],i)),!a||!o.length||!i.length)return!0
...
return!s.length||(this.data(s),!1)},"aria-required-children-evaluate":function(e,t,r){var n=t&&Array.isArray(t.reviewEmpty)?t.reviewEmpty:[],a=cs(r,{dpub:!0}),o=pD(a)
if(null===o)return!0
...
return r&&e.includes(r)}))}(o,i)||("true"===r.attr("aria-busy")?(this.data({messageKey:"aria-busy"}),!0):(this.data(o),!(!n.includes(a)||i.some(Mg))&&void 0))},"aria-required-children-matches":function(e,t){var r=cs(t,{dpub:!0})
return!!pD(r)},"aria-required-parent-evaluate":function(e,t,r){var n=t&&Array.isArray(t.ownGroupRoles)?t.ownGroupRoles:[],a=Og(r,n)
if(!a)return!0
...
if(o)for(var i=0,u=o.length;i<u;i++)if(!(a=Og(Za(o[i]),n,a,!0)))return!0
return this.data(a),!1},"aria-required-parent-matches":function(e,t){var r=cs(t)
return!!dD(r)},"aria-roledescription-evaluate":function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=Us(arguments.length>2?arguments[2]:void 0)
...
var n=[],a=/^aria-/
return r.attrNames.forEach((function(e){-1===t.indexOf(e)&&a.test(e)&&!hD(e)&&n.push(e)})),!n.length||(this.data(n),!1)},"aria-valid-attr-value-evaluate":function(e,t,r){t=Array.isArray(t.value)?t.value:[]
...
try{i=fD(r,e)}catch(t){return n="".concat(e,'="').concat(c,'"'),void(a="idrefs")}l[e]&&!l[e](i)||i||(""!==c||function(e){var t
...
return c=ym().includes(c)?c:"text",void 0===l?"text"===c:l.includes(c)},"autocomplete-matches":function(e,t){var r=t.attr("autocomplete")
if(!r||""===vs(r))return!1
...
if(void 0===u||"widget"!==u.type)return!1}return!("-1"===i&&t.actualNode&&!Ji(t)&&!Qs(t))},"autocomplete-valid-evaluate":function(e,t,r){var n=r.attr("autocomplete")||""
...
return"string"!=typeof o?(this.data({messageKey:"noRoleDescription"}),!1):""!==vs(o)||(this.data({messageKey:"emptyRoleDescription"}),!1)},"bypass-matches":function(e,t,r){return!Wg(0,0,r)||!!e.querySelector("a[href]")},"caption-evaluate":function(e,t,r){return!sm(r,"track").some((function(e){return"captions"===(e.attr("kind")||"").toLowerCase()}))&&void 0},"caption-faked-evaluate":function(e){var t=fs(e),r=t[0]
...
do{if(Bg(e.actualNode,":before")+Bg(e.actualNode,":after")>i)return e}while(e=e.parent)}}(n,{ignorePseudo:i,pseudoSizeThreshold:p})
...
var C=$D(e,{minRatio:.001,maxRatio:d})
if(null!==C){var x=[],A=ZD(e,x,d),k=rg(e,!1,A,t),N=null,T=null,B=null
if(0===C.length)N=tg(A,k)
else if(k&&A){B=[].concat(q(C),[A]).reduce(MD)
var R=tg(A,k),S=tg(A,B),_=tg(B,k);(N=Math.max(R,S,_))!==R&&(T=S>_?"shadowOnBgColor":"fgOnShadowColor")}var O=N>y
...
if(h&&ug(h))return!1}var m=sm(p,'input:not([type="hidden"],[type="image"],[type="button"],[type="submit"],[type="reset"]), select, textarea')[0]
if(m&&ug(m))return!1}for(var D=[],g=t;g;){if(g.props.id){var v=Gm(g).filter((function(e){return zf(e.getAttribute("aria-labelledby")||"").includes(g.props.id)})).map((function(e){return Za(e)}))
D.push.apply(D,q(v))}g=g.parent}if(D.length>0&&D.every(ug))return!1
if(!function(e){var t=Xs(e,!1,!0)
return""!==t&&""!==El(t,Yg)&&e.children.some((function(e){return"#text"===e.props.nodeName&&!yl(e)}))}(t))return!1
...
default:return parseInt(a)}}function g(e){return Math.round(e*(180/Math.PI))}},"data-table-large-matches":function(e){if(jm(e)){var t=fs(e)
return t.length>=3&&t[0].length>=3&&t[1].length>=3&&t[2].length>=3}return!1},"data-table-matches":function(e){return jm(e)},"deprecatedrole-evaluate":function(e,t,r){var n=Us(r,{dpub:!0,fallback:!0}),a=us.ariaRoles[n]
...
return!iD(e)&&n.some(Yu)},"duplicate-id-after":function(e){var t=[]
...
return!iD(e)&&n.every((function(e){return!Yu(e)}))},"duplicate-img-label-evaluate":function(e,t,r){if(["none","presentation"].includes(Us(r)))return!1
...
return!n||!n.length||!Jl()||void this.relatedNodes(n)},"focusable-no-name-evaluate":function(e,t,r){var n=r.attr("tabindex")
if(!(Yu(r)&&n>-1))return!1
...
var o=a.filter((function(e){return!n.includes(e.props.nodeName)}))
return this.relatedNodes(o.map((function(e){return e.actualNode}))),!(0!==o.length&&!Jl())||!!o.every((function(e){var t=e.getComputedStylePropertyValue("pointer-events"),r=parseInt(e.getComputedStylePropertyValue("width")),n=parseInt(e.getComputedStylePropertyValue("height"))
return e.actualNode.onfocus||(0===r||0===n)&&"none"===t}))&&void 0},"frame-focusable-content-evaluate":function(e,t,r){if(r.children)try{return!r.children.some((function(e){return Cg(e)}))}catch(e){return}},"frame-focusable-content-matches":function(e,t,r){var n,a
...
var n=Xh(r,t.selector,(function(e){return Qs(e)}))
...
return t.attributes.includes("xml:lang")&&t.attributes.includes("lang")&&yg(r.attr("xml:lang"))&&!yg(r.attr("lang"))&&!n?(this.data({messageKey:"noXHTML"}),!1):!!t.attributes.some((function(e){return yg(r.attr(e))}))||(this.data({messageKey:"noLang"}),!1)},"has-text-content-evaluate":function(e,t,r){try{return""!==vs(dl(r))}catch(e){return}},"has-widget-role-evaluate":function(e){var t=e.getAttribute("role")
if(null===t)return!1
var r=Yl(t)
...
return r.ancestry.length-n.ancestry.length})),e.reduce(cg,[]).filter((function(e){return-1!==e.level}))}(e)
return e.forEach((function(e){e.result=function(e,t){var r,n,a,o,i=dg(t,e.node.ancestry),u=null!==(r=null===(n=t[i])||void 0===n?void 0:n.level)&&void 0!==r?r:-1,s=null!==(a=null===(o=t[i-1])||void 0===o?void 0:o.level)&&void 0!==a?a:-1
return 0===i||(-1!==u?u-s<=1:void 0)}(e,t)})),e},"heading-order-evaluate":function(){var e=Xa.get("headingOrder")
if(e)return!0
var t=Xh(i._tree[0],"h1, h2, h3, h4, h5, h6, [role=heading], iframe, frame",Qs)
return e=t.map((function(e){return{ancestry:[Ga(e.actualNode)],level:lg(e)}})),this.data({headingOrder:e}),Xa.set("headingOrder",t),!0},"help-same-as-label-evaluate":function(e,t,r){var n=Tl(r),a=e.getAttribute("title")
...
if(o&&!Qs(o)){var i
try{i=Fl(r).trim()}catch(e){return}return""===i}}return!1},"html-namespace-matches":function(e,t){return!zg(0,t)},"html5-scope-evaluate":function(e){return!Wl(a)||"TH"===e.nodeName.toUpperCase()},"identical-links-same-purpose-after":function(e){if(e.length<2)return e
for(var t=e.filter((function(e){return void 0!==e.result})),r=[],n={},a=function(e){var a,o=t[e],i=o.data,u=i.name,s=i.urlProps
if(n[u])return 1
var l=t.filter((function(t,r){return t.data.name===u&&r!==e})),c=l.every((function(e){return sg(e.data.urlProps,s)}))
...
return!!n.every((function(e){return!ls(e.toLowerCase(),{allowAbstract:!0})}))&&(this.data(n),!0)},"is-element-focusable-evaluate":function(e,t,r){return Yu(r)},"is-initiator-matches":Wg,"is-on-screen-evaluate":function(e){return Ji(e)},"is-visible-matches":function(e){return Ji(e)},"is-visible-on-screen-matches":function(e,t){return Ji(t)},"label-content-name-mismatch-evaluate":function(e,t,r){var n,a,o,i,u=null==t?void 0:t.pixelThreshold,s=null!==(n=null==t?void 0:t.occurrenceThreshold)&&void 0!==n?n:null==t?void 0:t.occuranceThreshold,l=es(e).toLowerCase(),c=vs(dl(r,{subtreeDescendant:!0,ignoreIconLigature:!0,pixelThreshold:u,occurrenceThreshold:s})).toLowerCase()
return!c||(Cl(l)<1||Cl(c)<1?void 0:(a=c,o=Fg(l),i=Fg(a),!(!o||!i)&&o.includes(i)))},"label-content-name-mismatch-matches":function(e,t){var r=Us(e)
return!!(r&&Xm("widget").includes(r)&&Jm().includes(r)&&(vs(rs(t))||vs(ts(e)))&&vs(Xs(t)))},"label-matches":function(e,t){if("input"!==t.props.nodeName||!1===t.hasAttr("type"))return!0
var r=t.attr("type").toLowerCase()
return!1===["hidden","image","button","submit","reset"].includes(r)},"landmark-has-body-context-matches":function(e,t){return e.hasAttribute("role")||!xi(t,"article, aside, main, nav, section")},"landmark-is-top-level-evaluate":function(e){var t=Xm("landmark"),r=Wi(e),n=Us(e)
...
return a=a?a.toLowerCase():null,this.data({role:n,accessibleText:a}),this.relatedNodes([e]),!0},"landmark-unique-matches":function(e,t){return function(e){var t=Xm("landmark"),r=Us(e)
if(!r)return!1
var n=e.props.nodeName
return"section"===n||"form"===n?!!Fl(e):t.indexOf(r)>=0||"region"===r}(t)&&Qs(t)},"layout-table-matches":function(e){return!jm(e)&&!Yu(e)},"link-in-text-block-evaluate":function(e,t){var r=t.requiredContrastRatio,n=t.allowSameColor
if(Tg(e))return!1
for(var a=Wi(e);a&&1===a.nodeType&&!Tg(a);)a=Wi(a)
if(a){this.relatedNodes([a])
var o=rg(e),i=rg(a),u=ZD(e),s=ZD(a),l=o&&i?kg(o,i):void 0
...
return(!r||"link"===r)&&!!t&&!!Ji(e)&&Zl(e)},"link-in-text-block-style-evaluate":function(e){if(Ag(e))return!1
...
return!!["presentation","none","list"].includes(o)||(o&&ls(o)?(this.data({messageKey:"roleNotValid"}),!1):["ul","ol","menu"].includes(a))}},"matches-definition-evaluate":function(e,t,r){return Is(r,t.matcher)},"meta-refresh-evaluate":function(e,t,r){var n=t||{},a=n.minDelay,o=n.maxDelay,i=V((r.attr("content")||"").trim().split(wD),1)[0]
...
return!!r&&!!us.ariaRoles[r].childrenPresentational},"no-autoplay-audio-evaluate":function(e,t){if(e.duration){var r=t.allowedDuration,n=void 0===r?3:r
...
return t?1===t.length?Math.abs(e.duration-t[0]):Math.abs(t[1]-t[0]):Math.abs(e.duration-(e.currentTime||0))}(e)<=n&&!e.hasAttribute("loop")||!!e.hasAttribute("controls")}console.warn("axe.utils.preloadMedia did not load metadata")},"no-autoplay-audio-matches":function(e){return!!e.currentSrc&&!e.hasAttribute("paused")&&!e.hasAttribute("muted")},"no-empty-role-matches":function(e,t){return!!t.hasAttr("role")&&!!t.attr("role").trim()},"no-explicit-name-required-matches":$g,"no-focusable-content-evaluate":function(e,t,r){if(r.children)try{var n=wg(r)
...
return!(r&&0!==r.length||"combobox"===cs(t)&&sm(t,'input:not([type="hidden"])').length||uD(t,{popupRoles:["listbox"]}))},"no-negative-tabindex-matches":function(e,t){var r=parseInt(t.attr("tabindex"),10)
...
r||c||i.push(t),r&&!c&&(u.push(t),s.includes(l)||s.push(l)),c&&(a=!0)}}else n=!0})),n||i.length?(this.relatedNodes(i),!0):!o&&!a&&(this.relatedNodes(u),this.data({messageKey:"roleNotValid",roles:s.join(", ")}),!0)},"p-as-heading-evaluate":function(e,t,r){var n=Array.from(e.parentNode.children),a=n.indexOf(e),o=(t=t||{}).margins||[],i=n.slice(a+1).find((function(e){return"P"===e.nodeName.toUpperCase()})),u=n.slice(0,a).reverse().find((function(e){return"P"===e.nodeName.toUpperCase()})),s=yD(e),l=i?yD(i):null,c=u?yD(u):null,d=t.passLength,p=t.failLength,f=e.textContent.trim().length,h=null==i?void 0:i.textContent.trim().length
if(f>h*d)return!0
if(!l||!FD(s,l,o))return!0
var m=xi(r,"blockquote")
return!!(m&&"BLOCKQUOTE"===m.nodeName.toUpperCase()||c&&!FD(s,c,o)||f>h*p)&&void 0},"p-as-heading-matches":function(e){var t=Array.from(e.parentNode.childNodes),r=e.textContent.trim()
...
var a=Xh(i._tree[0],t.selector,(function(e){return Qs(e)}))
...
return e})).filter((function(e,t,r){return r.indexOf(e)===t}))}(t)})).includes(r)},"same-caption-summary-evaluate":function(e,t,r){if(void 0!==r.children){var n=r.attr("summary"),a=r.children.find(mD),o=!!a&&vs(dl(a))
return!(!o||!n)&&vs(n).toLowerCase()===vs(o).toLowerCase()}},"scope-value-evaluate":function(e,t){var r=e.getAttribute("scope").toLowerCase()
return-1!==t.values.indexOf(r)},"scrollable-region-focusable-matches":function(e,t){return void 0!==Eh(e,13)&&!1===uD(t)&&sm(t,"*").some((function(e){return Ll(e,!0,!0)}))},"skip-link-evaluate":function(e){var t=Lu(e,"href")
...
try{if(""===dl(n,{includeHidden:!0}).trim())return this.data({messageKey:"emptyTitle"}),!1}catch(e){return}return!0}},"tabindex-evaluate":function(e,t,r){var n=parseInt(r.attr("tabindex"),10)
return!!isNaN(n)||n<=0},"table-or-grid-role-matches":function(e,t){var r=Us(t)
...
var o=uu.bind(null,n),i=Tu(r),u=function(e,t){return t.filter((function(t){return!fg(t,e)&&Dg(e,t)}))}(r,i),s=function(e,t){var r,n=[],a=[],o=Q(t)
try{for(o.s();!(r=o.n()).done;){var i=r.value
!Dg(e,i)&&du(e,i)&&"none"!==hg(i)&&(fg(e,i)?n.push(i):a.push(i))}}catch(e){o.e(e)}finally{o.f()}return{fullyObscuringElms:n,partialObscuringElms:a}}(r,i),l=s.fullyObscuringElms,c=s.partialObscuringElms
if(u.length&&(l.length||!o(a)))return this.data({minSize:n,messageKey:"contentOverflow"}),void this.relatedNodes(gg(u))
if(l.length)return this.relatedNodes(gg(l)),this.data({messageKey:"obscured"}),!0
var d=!Qu(r)&&void 0
if(!o(a))return this.data(z({minSize:n},mg(a))),d
var p=c.filter((function(e){return"widget"===Yl(e)&&Yu(e)}))
if(!p.length)return this.data(z({minSize:n},mg(a))),!0
...
if(f){if(!o(f)){if(u.length)return this.data({minSize:n,messageKey:"contentOverflow"}),void this.relatedNodes(gg(u))
var h=p.every(Qu),m="partiallyObscured".concat(h?"":"NonTabbable")
return this.data(z({messageKey:m,minSize:n},mg(f))),this.relatedNodes(gg(p)),h?d:void 0}return this.data(z({minSize:n},mg(f||a))),this.relatedNodes(gg(p)),!0}this.data({minSize:n,messageKey:"tooManyRects"})},"td-has-header-evaluate":function(e){var t=[],r=Om(e),n=fs(e)
return r.forEach((function(e){zl(e)&&Pm(e)&&!lD(e)&&(Im(e,n).some((function(e){return null!==e&&!!zl(e)}))||t.push(e))})),!t.length||(this.relatedNodes(t),!1)},"td-headers-attr-evaluate":function(e){for(var t=[],r=[],n=[],a=0;a<e.rows.length;a++)for(var o=e.rows[a],i=0;i<o.cells.length;i++)t.push(o.cells[i])
...
var i=zf(o)
0!==i.length&&(e.getAttribute("id")&&(t=-1!==i.indexOf(e.getAttribute("id").trim())),a=i.some((function(e){return!u.includes(e)})),(t||a)&&n.push(e))}})),n.length>0?(this.relatedNodes(n),!1):!r.length||void this.relatedNodes(r)},"th-has-data-cells-evaluate":function(e){var t=Om(e),r=this,n=[]
...
Ds(e)&&(a=zm("down",t,o).find((function(t){return!Ds(t)&&Im(t,o).includes(e)}))),!a&&gs(e)&&(a=zm("right",t,o).find((function(t){return!gs(t)&&Im(t,o).includes(e)}))),a||r.relatedNodes(e),i=i&&a}})),!!i||void 0},"title-only-evaluate":function(e,t,r){var n=Tl(r),a=$s(r),o=r.attr("aria-describedby")
...
if("string"==typeof a){var o=Xf(a),i=t.value?!t.value.map(Xf).includes(o):!Em(o);(""!==o&&i||""!==a&&!vs(a))&&n.push(e+'="'+r.attr(e)+'"')}})),!(!n.length||"html"!==r.props.nodeName&&!Vl(r)||(this.data(n),0))},"valid-scrollable-semantics-evaluate":function(e,t){return function(e,t){var r=cs(e)
return r&&(_g[r]||t.roles.includes(r))||!1}(e,t)||function(e){var t=e.nodeName.toUpperCase()
return Sg[t]||!1}(e)},"widget-not-inline-matches":function(e,t){return Vg.every((function(r){return r(e,t)}))},"window-is-top-matches":function(e){return e.ownerDocument.defaultView.self===e.ownerDocument.defaultView.top},"xml-lang-mismatch-evaluate":function(e,t,r){return Xf(r.attr("lang"))===Xf(r.attr("xml:lang"))},"xml-lang-mismatch-matches":function(e){var t=Xf(e.getAttribute("lang")),r=Xf(e.getAttribute("xml:lang"))
return Em(t)&&Em(r)}},Xg=Kg,Zg=function(e){this.id=e.id,this.data=null,this.relatedNodes=[],this.result=null}
...
return(Array.isArray(e)||"object"!==o(e))&&(e={value:e}),e}function tv(e){e&&(this.id=e.id,this.configure(e))}tv.prototype.enabled=!0,tv.prototype.run=function(e,t,r,n,a){var o=(t=t||{}).hasOwnProperty("enabled")?t.enabled:this.enabled,i=this.getOptions(t.options)
if(o){var u,s=new Zg(this),l=ro(s,t,n,a)
try{u=this.evaluate.call(l,e.actualNode,i,e,r)}catch(t){return e&&e.actualNode&&(t.errorNode=ci.toSpec(e)),void a(t)}l.isAsync||(s.result=u,n(s))}else n(null)},tv.prototype.runSync=function(e,t,r){var n=(t=t||{}).enabled
if(!(void 0===n?this.enabled:n))return null
var a,o=this.getOptions(t.options),i=new Zg(this),u=ro(i,t)
u.async=function(){throw new Error("Cannot run async check while in a synchronous run")}
try{a=this.evaluate.call(u,e.actualNode,o,e,r)}catch(t){throw e&&e.actualNode&&(t.errorNode=ci.toSpec(e)),t}return i.result=a,i},tv.prototype.configure=function(e){var t=this
e.evaluate&&!Xg[e.evaluate]||(this._internalCheck=!0),e.hasOwnProperty("enabled")&&(this.enabled=e.enabled),e.hasOwnProperty("options")&&(this._internalCheck?this.options=ev(e.options):this.options=e.options),["evaluate","after"].filter((function(t){return e.hasOwnProperty(t)})).forEach((function(r){return t[r]=Jg(e[r])}))},tv.prototype.getOptions=function(e){return this._internalCheck?gi(this.options,ev(e||{})):e||this.options}
var rv=tv,nv=function(e){this.id=e.id,this.result=Jn.NA,this.pageLevel=e.pageLevel,this.impact=null,this.nodes=[]}
function av(e,t){this._audit=t,this.id=e.id,this.selector=e.selector||"*",e.impact&&(Da(Jn.impact.includes(e.impact),"Impact ".concat(e.impact," is not a valid impact")),this.impact=e.impact),this.excludeHidden="boolean"!=typeof e.excludeHidden||e.excludeHidden,this.enabled="boolean"!=typeof e.enabled||e.enabled,this.pageLevel="boolean"==typeof e.pageLevel&&e.pageLevel,this.reviewOnFail="boolean"==typeof e.reviewOnFail&&e.reviewOnFail,this.any=e.any||[],this.all=e.all||[],this.none=e.none||[],this.tags=e.tags||[],this.preload=!!e.preload,this.actIds=e.actIds,e.matches&&(this.matches=Jg(e.matches))}function ov(e){if(e.length){var t=!1,r={}
return e.forEach((function(e){var n=e.results.filter((function(e){return e}))
r[e.type]=n,n.length&&(t=!0)})),t?r:null}}av.prototype.matches=function(){return!0},av.prototype.gather=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r="mark_gather_start_"+this.id,n="mark_gather_end_"+this.id,a="mark_isVisibleToScreenReaders_start_"+this.id,o="mark_isVisibleToScreenReaders_end_"+this.id
t.performanceTimer&&Wh.mark(r)
var i=fm(this.selector,e)
return this.excludeHidden&&(t.performanceTimer&&Wh.mark(a),i=i.filter((function(e){return Qs(e)})),t.performanceTimer&&(Wh.mark(o),Wh.measure("rule_"+this.id+"#gather_axe.utils.isVisibleToScreenReaders",a,o))),t.performanceTimer&&(Wh.mark(n),Wh.measure("rule_"+this.id+"#gather",r,n)),i},av.prototype.runChecks=function(e,t,r,n,a,o){var i=this,u=xo()
this[e].forEach((function(e){var a=i._audit.checks[e.id||e],o=uh(a,i.id,r)
u.defer((function(e,r){a.run(t,o,n,e,r)}))})),u.then((function(t){t=t.filter((function(e){return e})),a({type:e,results:t})})).catch(o)},av.prototype.runChecksSync=function(e,t,r,n){var a=this,o=[]
return this[e].forEach((function(e){var i=a._audit.checks[e.id||e],u=uh(i,a.id,r)
o.push(i.runSync(t,u,n))})),{type:e,results:o=o.filter((function(e){return e}))}},av.prototype.run=function(e){var t=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2?arguments[2]:void 0,a=arguments.length>3?arguments[3]:void 0
r.performanceTimer&&this._trackPerformance()
var o,i=xo(),s=new nv(this)
try{o=this.gatherAndMatchNodes(e,r)}catch(e){return void a(new u({cause:e,ruleId:this.id}))}r.performanceTimer&&this._logGatherPerformance(o),o.forEach((function(n){i.defer((function(a,o){var i=xo();["any","all","none"].forEach((function(a){i.defer((function(o,i){t.runChecks(a,n,r,e,o,i)}))})),i.then((function(e){var r=ov(e)
r&&(r.node=new to(n),s.nodes.push(r),t.reviewOnFail&&(["any","all"].forEach((function(e){r[e].forEach((function(e){!1===e.result&&(e.result=void 0)}))})),r.none.forEach((function(e){!0===e.result&&(e.result=void 0)})))),a()})).catch((function(e){return o(e)}))}))})),i.defer((function(e){return setTimeout(e,0)})),r.performanceTimer&&this._logRulePerformance(),i.then((function(){return n(s)})).catch((function(e){return a(e)}))},av.prototype.runSync=function(e){var t=this,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
r.performanceTimer&&this._trackPerformance()
var n,a=new nv(this)
...
var i=ov(o)
i&&(i.node=n.actualNode?new to(n):null,a.nodes.push(i),t.reviewOnFail&&(["any","all"].forEach((function(e){i[e].forEach((function(e){!1===e.result&&(e.result=void 0)}))})),i.none.forEach((function(e){!0===e.result&&(e.result=void 0)}))))})),r.performanceTimer&&this._logRulePerformance(),a},av.prototype._trackPerformance=function(){this._markStart="mark_rule_start_"+this.id,this._markEnd="mark_rule_end_"+this.id,this._markChecksStart="mark_runchecks_start_"+this.id,this._markChecksEnd="mark_runchecks_end_"+this.id},av.prototype._logGatherPerformance=function(e){ea("gather (",e.length,"):",Wh.timeElapsed()+"ms"),Wh.mark(this._markChecksStart)},av.prototype._logRulePerformance=function(){Wh.mark(this._markChecksEnd),Wh.mark(this._markEnd),Wh.measure("runchecks_"+this.id,this._markChecksStart,this._markChecksEnd),Wh.measure("rule_"+this.id,this._markStart,this._markEnd)},av.prototype.gatherAndMatchNodes=function(e,t){var r=this,n="mark_matches_start_"+this.id,a="mark_matches_end_"+this.id,o=this.gather(e,t)
return t.performanceTimer&&Wh.mark(n),o=o.filter((function(t){return r.matches(t.actualNode,t,e)})),t.performanceTimer&&(Wh.mark(a),Wh.measure("rule_"+this.id+"#matches",n,a)),o},av.prototype.after=function(e,t){var r,n=this,a=di(r=this).map((function(e){var t=r._audit.checks[e.id||e]
...
return e.pageLevel&&r.length&&(r=[r.reduce((function(e,r){if(e)return t.forEach((function(t){e[t].push.apply(e[t],r[t])})),e}))]),r}(e),e},av.prototype.configure=function(e){e.hasOwnProperty("selector")&&(this.selector=e.selector),e.hasOwnProperty("excludeHidden")&&(this.excludeHidden="boolean"!=typeof e.excludeHidden||e.excludeHidden),e.hasOwnProperty("enabled")&&(this.enabled="boolean"!=typeof e.enabled||e.enabled),e.hasOwnProperty("pageLevel")&&(this.pageLevel="boolean"==typeof e.pageLevel&&e.pageLevel),e.hasOwnProperty("reviewOnFail")&&(this.reviewOnFail="boolean"==typeof e.reviewOnFail&&e.reviewOnFail),e.hasOwnProperty("any")&&(this.any=e.any),e.hasOwnProperty("all")&&(this.all=e.all),e.hasOwnProperty("none")&&(this.none=e.none),e.hasOwnProperty("tags")&&(this.tags=e.tags),e.hasOwnProperty("actIds")&&(this.actIds=e.actIds),e.hasOwnProperty("matches")&&(this.matches=Jg(e.matches)),e.impact&&(Da(Jn.impact.includes(e.impact),"Impact ".concat(e.impact," is not a valid impact")),this.impact=e.impact)}
var iv=de(Xn()),uv=/\{\{.+?\}\}/g,sv=W((function e(t){$(this,e),this.lang="en",this.defaultConfig=t,this.standards=us,this._init(),this._defaultLocale=null}),[{key:"_setDefaultLocale",value:function(){if(!this._defaultLocale){for(var e={checks:{},rules:{},failureSummaries:{},incompleteFallbackMessage:"",lang:this.lang},t=Object.keys(this.data.checks),r=0;r<t.length;r++){var n=t[r],a=this.data.checks[n].messages,o=a.pass,i=a.fail,u=a.incomplete
...
if(e?(t=no(e)).commons=e.commons:t={},t.reporter=t.reporter||null,t.noHtml=t.noHtml||!1,!t.allowedOrigins){var r=cv()
...
"object"===o(t)&&(this.data.checks[e.id]=t,"object"===o(t.messages)&&Object.keys(t.messages).filter((function(e){return t.messages.hasOwnProperty(e)&&"string"==typeof t.messages[e]})).forEach((function(e){0===t.messages[e].indexOf("function")&&(t.messages[e]=new Function("return "+t.messages[e]+";")())}))),this.checks[e.id]?this.checks[e.id].configure(e):this.checks[e.id]=new rv(e)}},{key:"run",value:function(e,t,r,n){this.normalizeOptions(t),to.setRunOptions(t),i._selectCache=[]
var a=function(e,t,r){return e.reduce((function(e,n){return cm(n,t,r)?n.preload?(e.later.push(n),e):(e.now.push(n),e):e}),{now:[],later:[]})}(this.rules,e,t),o=a.now,u=a.later,s=xo()
o.forEach((function(r){s.defer(Dv(r,e,t))}))
var l=xo()
u.length&&l.defer((function(e){nm(t).then((function(t){return e(t)})).catch((function(t){console.warn("Couldn't load preload assets: ",t),e(void 0)}))}))
var c=xo()
...
var c=xo()
u.forEach((function(r){var n=Dv(r,e,t)
...
var a=e.data.rules[n.id];("string"!=typeof a.helpUrl||t&&a.helpUrl===gv(t,n.id,r))&&(a.helpUrl=gv(e,n.id,r))}))}},{key:"resetRulesAndChecks",value:function(){this._init(),this._resetLocale()}}]),lv=sv
function cv(){return r.origin&&"null"!==r.origin?r.origin:r.location&&r.location.origin&&"null"!==r.location.origin?r.location.origin:void 0}function dv(e,t,r){var n,a
for(n=0,a=e.length;n<a;n++)t[r](e[n])}var pv=function(e,t){var r=t.pass,n=t.fail
return"string"==typeof r&&uv.test(r)&&(r=iv.default.compile(r)),"string"==typeof n&&uv.test(n)&&(n=iv.default.compile(n)),z({},e,{messages:{pass:r||e.messages.pass,fail:n||e.messages.fail,incomplete:"object"===o(e.messages.incomplete)?z({},e.messages.incomplete,t.incomplete):t.incomplete}})},fv=function(e,t){var r=t.help,n=t.description
return"string"==typeof r&&uv.test(r)&&(r=iv.default.compile(r)),"string"==typeof n&&uv.test(n)&&(n=iv.default.compile(n)),z({},e,{help:r||e.help,description:n||e.description})},hv=function(e,t){var r=t.failureMessage
return"string"==typeof r&&uv.test(r)&&(r=iv.default.compile(r)),z({},e,{failureMessage:r||e.failureMessage})},mv=function(e,t){return"string"==typeof t&&uv.test(t)&&(t=iv.default.compile(t)),t||e}
function Dv(e,t,r){return r.performanceTimer&&Wh.mark("mark_rule_start_"+e.id),function(n,a){e.run(t,r,(function(e){n(e)}),(function(t){if(r.debug)a(t)
else{var o=Object.assign(new nv(e),{result:Jn.CANTTELL,description:"An error occured while running this rule",message:t.message,stack:t.stack,error:t,errorNode:t.errorNode})
n(o)}}))}}function gv(e,t,r){var n=e.brand,a=e.application,o=e.lang
return Jn.helpUrlBase+n+"/"+(r||i.version.substring(0,i.version.lastIndexOf(".")))+"/"+t+"?application="+encodeURIComponent(a)+(o&&"en"!==o?"&lang="+encodeURIComponent(o):"")}function vv(e){var t=r&&"Node"in r&&"NodeList"in r,n=!!a
...
n||(Xa.set("globalDocumentSet",!0),a=e.ownerDocument),t||(Xa.set("globalWindowSet",!0),r=a.defaultView)}}var bv=function(){Xa.get("globalDocumentSet")&&(Xa.set("globalDocumentSet",!1),a=null),Xa.get("globalWindowSet")&&(Xa.set("globalWindowSet",!1),r=null),i._memoizedFns.forEach((function(e){return e.clear()})),Xa.clear(),i._tree=void 0,i._selectorData=void 0,i._selectCache=void 0}
function yv(e,t,r,n){try{e=new bh(e),i._tree=e.flatTree,i._selectorData=Pa(e.flatTree)}catch(e){return bv(),n(e)}var a=xo(),o=i._audit
t.performanceTimer&&Wh.auditStart(),e.frames.length&&!1!==t.iframes&&a.defer((function(r,n){mi(e,t,"rules",null,r,n)})),a.defer((function(r,n){o.run(e,t,r,n)})),a.then((function(a){try{t.performanceTimer&&Wh.auditEnd()
var i=hi(a.map((function(e){return{results:e}})))
e.initiator&&(t.performanceTimer&&Wh.mark("auditAfterStart"),i=o.after(i,t),t.performanceTimer&&(Wh.mark("auditAfterEnd"),Wh.measure("audit.after","auditAfterStart","auditAfterEnd"),Wh.logMeasures("audit.after")),i.forEach(im),i=i.map(da))
try{r(i,bv)}catch(e){bv(),ea(e)}}catch(e){bv(),n(e)}})).catch((function(e){bv(),n(e)}))}function Fv(e){this._run=e.run,this._collect=e.collect,this._registry={},e.commands.forEach((function(e){i._audit.registerCommand(e)}))}function wv(e){var t,r,n,u=V(e,3),s=u[0],l=u[1],c=u[2],d=new TypeError("axe.run arguments are invalid")
...
var s=e&&e.options||{}
switch(e.command){case"rules":return yv(u,s,(function(e,t){e=ci.mapRawResults(e),n(e),t()}),o)
case"cleanup-plugin":return Tm(n,o)
default:if(i._audit&&i._audit.commands&&i._audit.commands[e.command])return i._audit.commands[e.command](e,r)}})),ni.subscribe("axe.ping",(function(e,t,r){r({axe:!0})}))),Fv.prototype.run=function(){return this._run.apply(this,arguments)},Fv.prototype.collect=function(){return this._collect.apply(this,arguments)},Fv.prototype.cleanup=function(e){var t=i.utils.queue(),r=this
Object.keys(this._registry).forEach((function(e){t.defer((function(t){r._registry[e].cleanup(t)}))})),t.then(e)},Fv.prototype.add=function(e){this._registry[e.id]=e}
var Ev=function(){}
function Cv(e){var t=e.frames,r=e.frameSpec
return r?t.map((function(e){return ci.mergeSpecs(e,r)})):t}var xv=function(e,t,r){if("function"==typeof t&&(r=t,t={}),!e||!Array.isArray(e))return r(e)
r(e.map((function(e){for(var t=z({},e),r=0,n=["passes","violations","incomplete","inapplicable"];r<n.length;r++){var a=n[r]
t[a]=ci.mapRawNodeResults(t[a])}return t})))},Av={base:{Audit:lv,CheckResult:Zg,Check:rv,Context:bh,RuleResult:nv,Rule:av,metadataFunctionMap:Xg},public:{reporters:Bm},helpers:{failureSummary:Zf,incompleteFallbackMessage:Jf,processAggregate:th},utils:{setDefaultFrameMessenger:ti,cacheNodeSelectors:Wf,getNodesMatchingExpression:Uf,convertSelector:go},commons:{dom:{nativelyHidden:Si,displayHidden:_i,visibilityHidden:Oi,contentVisibiltyHidden:Mi,ariaHidden:Ii,opacityHidden:Pi,scrollHidden:ji,overflowHidden:qi,clipHidden:Li,areaHidden:zi,detailsHidden:Vi}}}
i._thisWillBeDeletedDoNotUse=Av,i.constants=Jn,i.log=ea,i.AbstractVirtualNode=ra,i.SerialVirtualNode=Nm,i.VirtualNode=Lf,i._cache=Xa,i.imports=ic,i.cleanup=Tm,i.configure=function(e){var t=i._audit
...
if(s!==m||D<l||D===l&&g<c||s===m&&l===D&&c===g&&o&&o!==f)throw new Error("Configured version ".concat(r," is not compatible with current axe version ").concat(i.version))}if(e.reporter&&("function"==typeof e.reporter||Rm(e.reporter))&&(t.reporter=e.reporter),e.checks){if(!Array.isArray(e.checks))throw new TypeError("Checks property must be an array")
...
return{ruleId:e.id,description:t.description,help:t.help,helpUrl:t.helpUrl,tags:e.tags,actIds:e.actIds}}))},i._load=function(e){i._audit=new lv(e)},i.plugins={},i.registerPlugin=function(e){i.plugins[e.id]=new Fv(e)},i.hasReporter=Rm,i.getReporter=Sm,i.addReporter=function(e,t,r){Bm[e]=t,r&&(km=t)},i.reset=function(){var e=i._audit
if(!e)throw new Error("No audit configured")
e.resetRulesAndChecks(),Object.keys(is).forEach((function(e){is[e]=os[e]}))},i._runRules=yv,i.runVirtualRule=function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
r.reporter=r.reporter||i._audit.reporter||"v1",i._selectorData={},t instanceof ra||(t=new Nm(t))
var n=Fh(e)
...
vv(t[0])
var n=wv(t),a=n.context,o=n.options,u=n.callback,s=void 0===u?Ev:u,l=function(e){var t,r,n
return"function"==typeof Promise&&e===Ev?t=new Promise((function(e,t){r=t,n=e})):(n=function(t){return e(null,t)},r=function(t){return e(t)}),{thenable:t,reject:r,resolve:n}}(s),c=l.thenable,d=l.resolve,p=l.reject
...
t(e.message)}(e,s)}return i._running=!0,o.performanceTimer&&Wh.start(),i._runRules(a,o,(function(e,t){var r=function(e){i._running=!1,t()
try{p(e)}catch(e){i.log(e)}}
try{o.performanceTimer&&Wh.mark("reporterStart"),function(e,t,r,n){var a=Sm(t.reporter)(e,t,r,n)
void 0!==a&&r(a)}(e,o,(function(e){o.performanceTimer&&(Wh.mark("reporterEnd"),Wh.measure("reporter","reporterStart","reporterEnd"),Wh.logMeasures("reporter"),Wh.end()),i._running=!1,t()
try{d(e)}catch(e){i.log(e)}}),r)}catch(e){r(e)}}),(function(e){o.performanceTimer&&Wh.end(),i._running=!1,s(e),p(e)})),c},i.setup=function(e){if(i._tree)throw new Error("Axe is already setup. Call `axe.teardown()` before calling `axe.setup` again.")
return e&&"object"===o(e.documentElement)&&"object"===o(e.defaultView)&&(e=e.documentElement),vv(e),i._tree=Yf(e),i._selectorData=Pa(i._tree),i._tree[0]},i.teardown=bv,i.runPartial=function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
var n=wv(t),a=n.options,o=n.context
...
return ci.toSpec(t)}))
return u.initiator&&(t=sh()),i._running=!1,bv(),{results:e,frames:r,environmentData:t}})).catch((function(e){return i._running=!1,bv(),Promise.reject(e)}))},i.finishRun=function(e){var t,r,n,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
a=no(a)
...
var u=hi(e)
return(u=i._audit.after(u,a)).forEach(im),function(e,t){return new Promise((function(r,n){Sm(t.reporter)(e,t,r,n)}))}(u=u.map(da),z({environmentData:o},a))},i.commons=CD,i.utils=na,i.addReporter("na",(function(e,t,r){console.warn('"na" reporter will be deprecated in axe v4.0. Use the "v2" reporter instead.'),"function"==typeof t&&(r=t,t={})
...
r({raw:e,env:t})}))})),i.addReporter("raw",xv),i.addReporter("v1",(function(e,t,r){"function"==typeof t&&(r=t,t={})
...
function T(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],r=t&&_("array",e)?[]:{}
...
default:return d(e)}}function _(e,t){return S(t)===e}function O(e,t){for(var r=e+""+t,n=0,a=0;a<r.length;a++)n=(n<<5)-n+r.charCodeAt(a),n|=0
...
var r=d(e),n=d(t)
return r!==n?("object"===r&&P.has(S(e))?e.valueOf():e)===("object"===n&&P.has(S(t))?t.valueOf():t):H[r](e,t)}function G(e,t){var r=$(e,t)
...
r--}return!0}var Y={altertitle:!0,collapse:!0,countStepsAsOne:!1,failOnZeroTests:!0,filter:void 0,maxDepth:5,module:void 0,moduleId:void 0,reorder:!0,requireExpects:!1,scrolltop:!0,storage:F,testId:void 0,urlConfig:[],currentModule:{name:"",tests:[],childModules:[],testsRun:0,testsIgnored:0,hooks:{before:[],beforeEach:[],afterEach:[],after:[]}},globalHooks:{},pq:null,_deprecated_timeout_shown:!1,_deprecated_countEachStep_shown:!1,blocking:!0,callbacks:{},modules:[],queue:[],stats:{all:0,bad:0,testCount:0}}
function Q(e,t){("boolean"==typeof e||"string"==typeof e&&""!==e)&&(Y[t]=!0===e||"true"===e)}function K(e,t){("number"==typeof e||"string"==typeof e&&/^[0-9]+$/.test(e))&&(Y[t]=+e)}function X(e,t){"string"==typeof e&&""!==e&&(Y[t]=e)}function Z(e,t){"string"==typeof e&&""!==e&&(Y[t]=[e])}function J(e){var t
Q(e.qunit_config_altertitle,"altertitle"),Q(e.qunit_config_autostart,"autostart"),Q(e.qunit_config_collapse,"collapse"),Q(e.qunit_config_failonzerotests,"failOnZeroTests"),X(e.qunit_config_filter,"filter"),X(e.qunit_config_fixture,"fixture"),Q(e.qunit_config_hidepassed,"hidepassed"),K(e.qunit_config_maxdepth,"maxDepth"),X(e.qunit_config_module,"module"),Z(e.qunit_config_moduleid,"moduleId"),Q(e.qunit_config_noglobals,"noglobals"),Q(e.qunit_config_notrycatch,"notrycatch"),Q(e.qunit_config_reorder,"reorder"),Q(e.qunit_config_requireexpects,"requireExpects"),Q(e.qunit_config_scrolltop,"scrolltop"),("boolean"==typeof(t=e.qunit_config_seed)||"string"==typeof t&&""!==t)&&(Y.seed=t),Z(e.qunit_config_testid,"testId"),K(e.qunit_config_testtimeout,"testTimeout")}g&&"env"in g&&J(g.env),J(f)
...
var de=(fe(0)||"").replace(/(:\d+)+\)?/g,"").replace(/.+[/\\]/,"")
...
return[e,t]}function De(e,t,r){var n=!1,a=S(t)
...
n.preserveEnvironment=!0}if("after"!==t||function(e){return e.testsRun===je(e).filter((function(e){return!e.skip})).length-1}(r)||!(Y.queue.length>0||Y.pq.taskCount()>2))if(Y.current=n,Y.notrycatch)a()
...
o?Le(r):function(e){for(e.testsRun++;e=e.parentModule;)e.testsRun++}(r),s&&(u?s.setItem("qunit-test-"+n+"-"+a,u):s.removeItem("qunit-test-"+n+"-"+a)),be("testEnd",this.testReport.end(!0)),this.testReport.slimAssertions()
var d=this
return Ce("testDone",{name:a,module:n,skipped:o,todo:i,failed:u,passed:this.assertions.length-u,total:this.assertions.length,runtime:o?0:this.runtime,assertions:this.assertions,testId:this.testId,get source(){return d.stack}}).then((function(){if(qe(r)){for(var e=[r],t=r.parentModule;t&&qe(t);)e.push(t),t=t.parentModule
var n=Ee.resolve()
...
a&&(n.source=a)}this.logAssertion(n),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t){if(!(this instanceof Ae))throw new Error("pushFailure() assertion outside test context, was "+fe(2))
...
a.remaining--,0===a.remaining&&r.pauses.delete(n),Pe(r)}}},resolvePromise:function(e,t){if(null!=e){var r=this,n=e.then
...
r.pushFailure(n,pe(e,0)),Ne(),Ie(r)}))}}},valid:function(){if(this.callback&&this.callback.validTest)return!0
...
var Te=!1
function Be(e){Te||Y.currentModule.ignored||new Ae(e).queue()}function Re(e){Y.currentModule.ignored||(Te||(Y.queue.length=0,Te=!0),new Ae(e).queue())}function Se(e,t){Be({testName:e,callback:t})}function _e(e,t){return"".concat(e," [").concat(t,"]")}var Oe=/[\x00-\x1F\x7F\xA0]/
function Me(e,t){if(Array.isArray(e))for(var r=0;r<e.length;r++){var n=e[r],a=d(n),o=r
if("string"===a&&n.length<=40&&!Oe.test(n)&&!/\s*\d+: /.test(n))o=n
else if("string"===a||"number"===a||"boolean"===a||"undefined"===a||null===n){var i=String(n)
Oe.test(i)||(o=r+": "+(i.length<=30?i:i.slice(0,29)+"…"))}t(n,o)}else{if("object"!==d(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(d(e)," instead."))
for(var u in e)t(e[u],u)}}function Ie(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Pe(e)}function Pe(e){e.pauses.size>0||(m?(D(Y.timeout),Y.timeout=m((function(){e.pauses.size>0||(D(Y.timeout),Y.timeout=null,Y.blocking=!1,Y.pq.advance())}))):(Y.blocking=!1,Y.pq.advance()))}function je(e){for(var t=[].concat(e.tests),r=l(e.childModules);r.length;){var n=r.shift()
t.push.apply(t,n.tests),r.push.apply(r,l(n.childModules))}return t}function qe(e){return e.testsRun+e.testsIgnored===je(e).length}function Le(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}R(Se,{todo:function(e,t){Be({testName:e,callback:t,todo:!0})},skip:function(e){Be({testName:e,skip:!0})},if:function(e,t,r){Be({testName:e,callback:r,skip:!t})},only:function(e,t){Re({testName:e,callback:t})},each:function(e,t,r){Me(t,(function(t,n){Be({testName:_e(e,n),callback:r,withData:!0,stackOffset:5,data:t})}))}}),Se.todo.each=function(e,t,r){Me(t,(function(t,n){Be({testName:_e(e,n),callback:r,todo:!0,withData:!0,stackOffset:5,data:t})}))},Se.skip.each=function(e,t){Me(t,(function(t,r){Be({testName:_e(e,r),stackOffset:5,skip:!0})}))},Se.if.each=function(e,t,r,n){Me(r,(function(r,a){Be({testName:_e(e,a),callback:n,withData:!0,stackOffset:5,skip:!t,data:t?r:void 0})}))},Se.only.each=function(e,t,r){Me(t,(function(t,n){Re({testName:_e(e,n),callback:r,withData:!0,stackOffset:5,data:t})}))}
var ze,Ve,Ue,He,$e=function(){function e(t){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
o(this,e),this.log=r.log||Function.prototype.bind.call(h.log,h),t.on("error",this.onError.bind(this)),t.on("runStart",this.onRunStart.bind(this)),t.on("testStart",this.onTestStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this)),t.on("runEnd",this.onRunEnd.bind(this))}return u(e,[{key:"onError",value:function(e){this.log("error",e)}},{key:"onRunStart",value:function(e){this.log("runStart",e)}},{key:"onTestStart",value:function(e){this.log("testStart",e)}},{key:"onTestEnd",value:function(e){this.log("testEnd",e)}},{key:"onRunEnd",value:function(e){this.log("runEnd",e)}}],[{key:"init",value:function(t,r){return new e(t,r)}}])}(),Ge=v&&void 0!==v.performance&&"function"==typeof v.performance.mark&&"function"==typeof v.performance.measure?v.performance:void 0,We={measure:Ge?function(e,t,r){try{Ge.measure(e,t,r)}catch(e){re.warn("performance.measure could not be executed because of ",e.message)}}:function(){},mark:Ge?Ge.mark.bind(Ge):function(){}},Ye=function(){function e(t){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
o(this,e),this.perf=r.perf||We,t.on("runStart",this.onRunStart.bind(this)),t.on("runEnd",this.onRunEnd.bind(this)),t.on("suiteStart",this.onSuiteStart.bind(this)),t.on("suiteEnd",this.onSuiteEnd.bind(this)),t.on("testStart",this.onTestStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this))}return u(e,[{key:"onRunStart",value:function(){this.perf.mark("qunit_suite_0_start")}},{key:"onSuiteStart",value:function(e){var t=e.fullName.length
...
this.perf.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}},{key:"onRunEnd",value:function(){this.perf.mark("qunit_suite_0_end"),this.perf.measure("QUnit Test Run","qunit_suite_0_start","qunit_suite_0_end")}}],[{key:"init",value:function(t,r){return new e(t,r)}}])}(),Qe=!0
if("undefined"!=typeof process){var Ke=process.env||{}
ze=Ke.FORCE_COLOR,Ve=Ke.NODE_DISABLE_COLORS,Ue=Ke.NO_COLOR,He=Ke.TERM,Qe=process.stdout&&process.stdout.isTTY}var Xe={enabled:!Ve&&null==Ue&&"dumb"!==He&&(null!=ze&&"0"!==ze||Qe),reset:Je(0,0),bold:Je(1,22),dim:Je(2,22),italic:Je(3,23),underline:Je(4,24),inverse:Je(7,27),hidden:Je(8,28),strikethrough:Je(9,29),black:Je(30,39),red:Je(31,39),green:Je(32,39),yellow:Je(33,39),blue:Je(34,39),magenta:Je(35,39),cyan:Je(36,39),white:Je(37,39),gray:Je(90,39),grey:Je(90,39),bgBlack:Je(40,49),bgRed:Je(41,49),bgGreen:Je(42,49),bgYellow:Je(43,49),bgBlue:Je(44,49),bgMagenta:Je(45,49),bgCyan:Je(46,49),bgWhite:Je(47,49)}
function Ze(e,t){for(var r,n=0,a="",o="";n<e.length;n++)a+=(r=e[n]).open,o+=r.close,~t.indexOf(r.close)&&(t=t.replace(r.rgx,r.close+r.open))
return a+t+o}function Je(e,t){var r={open:"[".concat(e,"m"),close:"[".concat(t,"m"),rgx:new RegExp("\\x1b\\[".concat(t,"m"),"g")}
return function(t){return void 0!==this&&void 0!==this.has?(~this.has.indexOf(e)||(this.has.push(e),this.keys.push(r)),void 0===t?this:Xe.enabled?Ze(this.keys,t+""):t+""):void 0===t?((n={has:[e],keys:[r]}).reset=Xe.reset.bind(n),n.bold=Xe.bold.bind(n),n.dim=Xe.dim.bind(n),n.italic=Xe.italic.bind(n),n.underline=Xe.underline.bind(n),n.inverse=Xe.inverse.bind(n),n.hidden=Xe.hidden.bind(n),n.strikethrough=Xe.strikethrough.bind(n),n.black=Xe.black.bind(n),n.red=Xe.red.bind(n),n.green=Xe.green.bind(n),n.yellow=Xe.yellow.bind(n),n.blue=Xe.blue.bind(n),n.magenta=Xe.magenta.bind(n),n.cyan=Xe.cyan.bind(n),n.white=Xe.white.bind(n),n.gray=Xe.gray.bind(n),n.grey=Xe.grey.bind(n),n.bgBlack=Xe.bgBlack.bind(n),n.bgRed=Xe.bgRed.bind(n),n.bgGreen=Xe.bgGreen.bind(n),n.bgYellow=Xe.bgYellow.bind(n),n.bgBlue=Xe.bgBlue.bind(n),n.bgMagenta=Xe.bgMagenta.bind(n),n.bgCyan=Xe.bgCyan.bind(n),n.bgWhite=Xe.bgWhite.bind(n),n):Xe.enabled?Ze([r],t+""):t+""
var n}}function et(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:4
...
var dt={}
Y.currentModule.suiteReport=oe,Y.pq=new it(Se)
var pt=!1,ft=!1
...
be("runStart",oe.start(!0)),Ce("begin",{totalTests:Ae.count,modules:e}).then(mt)}}dt.isLocal=v&&v.location&&"file:"===v.location.protocol,dt.version="2.23.1",R(dt,{config:Y,diff:function(e,t){var r,n
return n=(r=new st).DiffMain(e,t),r.diffCleanupEfficiency(n),r.diffPrettyHtml(n)},dump:te,equiv:W,reporters:nt,hooks:ot,is:_,objectType:S,on:function(e,t){if("string"!=typeof e)throw new TypeError("eventName must be a string when registering a listener")
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,ut(t),!1},onUncaughtException:ut,pushFailure:ke,assert:he.prototype,module:ce,test:Se,todo:Se.todo,skip:Se.skip,only:Se.only,start:function(e){if(Y.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=pt
...
for(var S=new Array(y),_=y-1;_>=0;--_)S[_]=m.poll()
S.total=y+F,i(S)}e?setImmediate(w):w()}))
...
e[i.id]&&!t&&(a+="<option value='"+(u=I(e[i.id]))+"' selected='selected' disabled='disabled'>"+u+"</option>"),a+="</select></label>"}else a+="<label for='qunit-urlconfig-"+u+"' title='"+s+"'><input id='qunit-urlconfig-"+u+"' name='"+u+"' type='checkbox'"+(i.value?" value='"+I(i.value)+"'":"")+(e[i.id]?" checked='checked'":"")+" title='"+s+"' />"+I(i.label)+"</label>"}return a}(),g(s,"qunit-url-config"),m(s.getElementsByTagName("input"),"change",k),m(s.getElementsByTagName("select"),"change",k),s))
...
S(e.name,e.testId,e.module),(t=C("qunit-testresult-display"))&&(g(t,"running"),r=dt.config.reorder&&e.previousFailure,t.innerHTML=[P(bt),r?"Rerunning previously failed test: <br />":"Running: ",O(e.name,e.module),_(bt.failedTests)].join(""))})),dt.log((function(e){var t=C("qunit-test-output-"+e.testId)
if(t){var r,n,a,o=I(e.message)||(e.result?"okay":"failed")
o="<span class='test-message'>"+o+"</span>",o+="<span class='runtime'>@ "+e.runtime+" ms</span>"
var i=!1
e.result||void 0===e.expected&&void 0===e.actual?!e.result&&e.source&&(o+="<table><tr class='test-source'><th>Source: </th><td><pre>"+I(e.source)+"</pre></td></tr></table>"):(r=e.negative?"NOT "+dt.dump.parse(e.expected):dt.dump.parse(e.expected),n=dt.dump.parse(e.actual),o+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+I(r)+"</pre></td></tr>",n!==r?(o+="<tr class='test-actual'><th>Result: </th><td><pre>"+I(n)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(i=!0,a=((a=e.actual-e.expected)>0?"+":"")+a):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(i=j(a=dt.diff(r,n)).length!==j(r).length+j(n).length),i&&(o+="<tr class='test-diff'><th>Diff: </th><td><pre>"+a+"</pre></td></tr>")):-1!==r.indexOf("[object Array]")||-1!==r.indexOf("[object Object]")?o+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+dt.dump.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+I(N({maxDepth:0}))+"'>Rerun without max depth</a>.</p></td></tr>":o+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(o+="<tr class='test-source'><th>Source: </th><td><pre>"+I(e.source)+"</pre></td></tr>"),o+="</table>")
var u=t.getElementsByTagName("ol")[0],s=b.createElement("li")
s.className=e.result?"pass":"fail",s.innerHTML=o,u.appendChild(s)}})),dt.testDone((function(n){var a=C("qunit-tests"),o=C("qunit-test-output-"+n.testId)
if(a&&o){var i
...
v.innerHTML="<strong>Source: </strong>"+I(n.source),g(v,"qunit-source"),c&&g(v,"qunit-collapsed"),d(p,"click",(function(){F(v,"qunit-collapsed")})),o.appendChild(v)}e.hidepassed&&("passed"===i||n.skipped)&&(t.push(o),a.removeChild(o))}})),dt.on("error",(function(e){var t=S("global failure")
if(t){var r=I(M(e))
...
if(n.checked){for(var l=0;l<u;l++){var c=s[l],d=c?c.className:"",f=d.indexOf("pass")>-1,h=d.indexOf("skipped")>-1;(f||h)&&t.push(c)}var m,D=function(e){var t="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"]
if(!t){if(Array.isArray(e)||(t=p(e))){t&&(e=t)
var r=0,n=function(){}
...
i.removeChild(g)}}catch(e){D.e(e)}finally{D.f()}}else for(;t.length;)i.appendChild(t.shift())}v.history.replaceState(null,"",o)}else v.location=o}function N(e){var t="?",r=v.location
...
v.location=N({filter:""===e?void 0:e,moduleId:l(o.selectedMap.keys()),module:void 0,testId:void 0})}function B(e,t,r){return'<li><label class="clickable'+(r?" checked":"")+'"><input type="checkbox" value="'+I(e)+'"'+(r?' checked="checked"':"")+" />"+I(t)+"</label></li>"}function S(e,t,r){var n=C("qunit-tests")
...
return u.className="qunit-assert-list",o.appendChild(u),n.appendChild(o),o}}function _(e){return 0===e.length?"":["<br /><a href='"+I(N({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function O(e,t){var r=""
